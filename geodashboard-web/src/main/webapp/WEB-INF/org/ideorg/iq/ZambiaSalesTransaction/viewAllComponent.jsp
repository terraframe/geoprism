...
<c:set var="page_title" scope="request" value="View all Zambia Sales Transaction"/>
<mjl:table var="item" query="${query}">
  <mjl:context action="org.ideorg.iq.ZambiaSalesTransactionController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="org.ideorg.iq.ZambiaSalesTransactionController.view.mojo">
          View
...
<br />
<mjl:commandLink name="ZambiaSalesTransactionController.newInstance" action="org.ideorg.iq.ZambiaSalesTransactionController.newInstance.mojo">
  Create a new Zambia Sales Transaction
</mjl:commandLink>
