...
<c:set var="page_title" scope="request" value="View a Zambia Sales Transaction"/>
<dl>
  <mjl:form id="org.ideorg.iq.ZambiaSalesTransaction.form.id" name="org.ideorg.iq.ZambiaSalesTransaction.form.name" method="POST">
    ...
    <mjl:command name="org.ideorg.iq.ZambiaSalesTransaction.form.edit.button" value="Edit" action="org.ideorg.iq.ZambiaSalesTransactionController.edit.mojo" />
  </mjl:form>
</dl>
<dl>
  <dt>
...
<mjl:commandLink name="org.ideorg.iq.ZambiaSalesTransaction.viewAll.link" action="org.ideorg.iq.ZambiaSalesTransactionController.viewAll.mojo">
  View All
</mjl:commandLink>
