...
<c:set var="page_title" scope="request" value="View all Enterprise"/>
<mjl:table var="item" query="${query}">
  <mjl:context action="org.ideorg.iq.EnterpriseController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="org.ideorg.iq.EnterpriseController.view.mojo">
          View
...
<br />
<mjl:commandLink name="EnterpriseController.newInstance" action="org.ideorg.iq.EnterpriseController.newInstance.mojo">
