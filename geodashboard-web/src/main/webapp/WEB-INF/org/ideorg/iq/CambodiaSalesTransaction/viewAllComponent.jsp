...
<c:set var="page_title" scope="request" value="View all Cambodia Sales Transaction"/>
<mjl:table var="item" query="${query}">
  <mjl:context action="org.ideorg.iq.CambodiaSalesTransactionController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="org.ideorg.iq.CambodiaSalesTransactionController.view.mojo">
          View
...
<br />
<mjl:commandLink name="CambodiaSalesTransactionController.newInstance" action="org.ideorg.iq.CambodiaSalesTransactionController.newInstance.mojo">
  Create a new Cambodia Sales Transaction
</mjl:commandLink>
