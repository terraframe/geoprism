...
<c:set var="page_title" scope="request" value="View a Cambodia LB Enterprise"/>
<dl>
  <mjl:form id="org.ideorg.iq.CambodiaLBEnterprise.form.id" name="org.ideorg.iq.CambodiaLBEnterprise.form.name" method="POST">
    ...
    <mjl:component param="dto" item="${item}">
      <mjl:dt attribute="salesCumulative">
        ${item.salesCumulative}
      </mjl:dt>
    ...
    <mjl:command name="org.ideorg.iq.CambodiaLBEnterprise.form.edit.button" value="Edit" action="org.ideorg.iq.CambodiaLBEnterpriseController.edit.mojo" />
  </mjl:form>
</dl>
<dl>
  <dt>
...
<mjl:commandLink name="org.ideorg.iq.CambodiaLBEnterprise.viewAll.link" action="org.ideorg.iq.CambodiaLBEnterpriseController.viewAll.mojo">
  View All
</mjl:commandLink>
