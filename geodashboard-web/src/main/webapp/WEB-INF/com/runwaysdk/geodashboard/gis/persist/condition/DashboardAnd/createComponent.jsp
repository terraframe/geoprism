...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.persist.condition.DashboardAnd.form.id" name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardAnd.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardAnd.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.persist.condition.DashboardAndController.create.mojo" />
  </mjl:form>
</dl>
