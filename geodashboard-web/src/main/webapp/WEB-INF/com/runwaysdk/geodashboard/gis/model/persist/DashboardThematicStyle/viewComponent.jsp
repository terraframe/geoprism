...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyle.form.id" name="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyle.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyle.form.edit.button" value="Edit" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyleController.edit.mojo" />
  </mjl:form>
</dl>
<dl>
  <dt>
  ...
  <dd>
    <ul>
      <li>
        <mjl:commandLink name="com.runwaysdk.geodashboard.gis.model.persist.HasStyle.childQuery.link" action="com.runwaysdk.geodashboard.gis.model.persist.HasStyleController.childQuery.mojo">
...
<mjl:commandLink name="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyle.viewAll.link" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyleController.viewAll.mojo">
  View All
</mjl:commandLink>
