...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardLessThanOrEqual.form.id" name="com.runwaysdk.geodashboard.gis.DashboardLessThanOrEqual.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardLessThanOrEqual.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.DashboardLessThanOrEqualController.create.mojo" />
  </mjl:form>
</dl>
