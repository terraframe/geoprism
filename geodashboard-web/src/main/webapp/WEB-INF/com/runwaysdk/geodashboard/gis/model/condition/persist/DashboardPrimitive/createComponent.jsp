...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardPrimitive.form.id" name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardPrimitive.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardPrimitive.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardPrimitiveController.create.mojo" />
  </mjl:form>
</dl>
