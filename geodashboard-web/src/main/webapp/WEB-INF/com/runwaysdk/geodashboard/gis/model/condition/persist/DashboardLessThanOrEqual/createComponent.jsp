...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThanOrEqual.form.id" name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThanOrEqual.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThanOrEqual.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThanOrEqualController.create.mojo" />
  </mjl:form>
</dl>
