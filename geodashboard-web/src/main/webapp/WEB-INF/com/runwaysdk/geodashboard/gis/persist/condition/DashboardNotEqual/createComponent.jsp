...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.persist.condition.DashboardNotEqual.form.id" name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardNotEqual.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardNotEqual.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.persist.condition.DashboardNotEqualController.create.mojo" />
  </mjl:form>
</dl>
