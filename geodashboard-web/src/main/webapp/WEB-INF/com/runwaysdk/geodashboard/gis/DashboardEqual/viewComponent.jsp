...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardEqual.form.id" name="com.runwaysdk.geodashboard.gis.DashboardEqual.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardEqual.form.edit.button" value="Edit" action="com.runwaysdk.geodashboard.gis.DashboardEqualController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.geodashboard.gis.DashboardEqual.viewAll.link" action="com.runwaysdk.geodashboard.gis.DashboardEqualController.viewAll.mojo">
  View All
</mjl:commandLink>
