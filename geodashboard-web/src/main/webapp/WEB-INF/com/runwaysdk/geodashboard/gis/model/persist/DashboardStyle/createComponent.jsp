...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.persist.DashboardStyle.form.id" name="com.runwaysdk.geodashboard.gis.model.persist.DashboardStyle.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.persist.DashboardStyle.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardStyleController.create.mojo" />
  </mjl:form>
</dl>
