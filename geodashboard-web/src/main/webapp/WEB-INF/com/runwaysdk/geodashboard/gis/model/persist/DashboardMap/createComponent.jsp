...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.persist.DashboardMap.form.id" name="com.runwaysdk.geodashboard.gis.model.persist.DashboardMap.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.persist.DashboardMap.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardMapController.create.mojo" />
  </mjl:form>
</dl>
