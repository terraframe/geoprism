...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.persist.condition.DashboardLessThan.form.id" name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardLessThan.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardLessThan.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.persist.condition.DashboardLessThanController.create.mojo" />
  </mjl:form>
</dl>
