...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardAnd.form.id" name="com.runwaysdk.geodashboard.gis.DashboardAnd.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardAnd.form.edit.button" value="Edit" action="com.runwaysdk.geodashboard.gis.DashboardAndController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.geodashboard.gis.DashboardAnd.viewAll.link" action="com.runwaysdk.geodashboard.gis.DashboardAndController.viewAll.mojo">
  View All
</mjl:commandLink>
