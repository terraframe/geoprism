...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.id" name="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.persist.HasStyleController.create.mojo" />
  </mjl:form>
</dl>
