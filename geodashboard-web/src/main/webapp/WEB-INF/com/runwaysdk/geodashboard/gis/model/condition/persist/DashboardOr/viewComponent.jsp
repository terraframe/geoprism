...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.id" name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.edit.button" value="Edit" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOrController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.viewAll.link" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOrController.viewAll.mojo">
  View All
</mjl:commandLink>
