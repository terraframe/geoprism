...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThan.form.id" name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThan.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThan.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardLessThanController.create.mojo" />
  </mjl:form>
</dl>
