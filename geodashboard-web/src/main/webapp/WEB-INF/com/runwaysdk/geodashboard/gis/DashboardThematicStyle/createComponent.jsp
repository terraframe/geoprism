...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardThematicStyle.form.id" name="com.runwaysdk.geodashboard.gis.DashboardThematicStyle.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardThematicStyle.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.DashboardThematicStyleController.create.mojo" />
  </mjl:form>
</dl>
