...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardComposite.form.id" name="com.runwaysdk.geodashboard.gis.DashboardComposite.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardComposite.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.DashboardCompositeController.create.mojo" />
  </mjl:form>
</dl>
