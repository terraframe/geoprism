...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardPrimitive.form.id" name="com.runwaysdk.geodashboard.gis.DashboardPrimitive.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardPrimitive.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.DashboardPrimitiveController.create.mojo" />
  </mjl:form>
</dl>
