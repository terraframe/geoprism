...
//    	            			  '<span data-rwId="'+ nodeId +'" class="ico ontology-category-color-icon" style="background:#00bfff; border:1px solid #ccc; width:20px; height:20px; float:right; cursor:pointer;">icon</span>' +
//    	            			  '</a>');
