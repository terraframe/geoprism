...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.DashboardMap.form.id" name="com.runwaysdk.geodashboard.gis.DashboardMap.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.DashboardMap.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.DashboardMapController.create.mojo" />
  </mjl:form>
</dl>
