...
<mjl:form id="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.id" name="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.name" method="POST">
  <dl>
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.HasStyle.form.newInstance.button" value="New Instance" action="com.runwaysdk.geodashboard.gis.persist.HasStyleController.newInstance.mojo" />
  </dl>
</mjl:form>
