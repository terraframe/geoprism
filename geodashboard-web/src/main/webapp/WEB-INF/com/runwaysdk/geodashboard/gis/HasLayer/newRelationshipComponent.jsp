...
<mjl:form id="com.runwaysdk.geodashboard.gis.HasLayer.form.id" name="com.runwaysdk.geodashboard.gis.HasLayer.form.name" method="POST">
  <dl>
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.HasLayer.form.newInstance.button" value="New Instance" action="com.runwaysdk.geodashboard.gis.HasLayerController.newInstance.mojo" />
  </dl>
</mjl:form>
