...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.id" name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOr.form.create.button" value="Create" action="com.runwaysdk.geodashboard.gis.model.condition.persist.DashboardOrController.create.mojo" />
  </mjl:form>
</dl>
