...
<mjl:table var="item" query="${query}">
  <mjl:context action="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyleController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:attributeColumn attributeName="styleCondition">
      <mjl:row>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyleController.view.mojo">
          View
...
<br />
<mjl:commandLink name="DashboardThematicStyleController.newInstance" action="com.runwaysdk.geodashboard.gis.model.persist.DashboardThematicStyleController.newInstance.mojo">
