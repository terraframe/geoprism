Mojo.Meta.newClass('com.runwaysdk.system.Transition', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.system.Transition'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('transitionName').getValue();
    },
    setTransitionName : function(value)
    {
      var attributeDTO = this.getAttributeDTO('transitionName');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isTransitionNameReadable : function()
    {
      return this.getAttributeDTO('transitionName').isReadable();
    },
    isTransitionNameWritable : function()
    {
      return this.getAttributeDTO('transitionName').isWritable();
    },
    isTransitionNameModified : function()
    {
      return this.getAttributeDTO('transitionName').isModified();
    },
    getTransitionNameMd : function()
    {
      return this.getAttributeDTO('transitionName').getAttributeMdDTO();
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.TransitionQueryDTO', {
