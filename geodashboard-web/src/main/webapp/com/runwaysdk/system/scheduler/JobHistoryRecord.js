Mojo.Meta.newClass('com.runwaysdk.system.scheduler.JobHistoryRecord', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.system.scheduler.JobHistoryRecord'
  },
  Instance: 
  {
...
Mojo.Meta.newClass('com.runwaysdk.system.scheduler.JobHistoryRecordQueryDTO', {
