Mojo.Meta.newClass('com.runwaysdk.system.TypePermission', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.system.TypePermission'
  },
  Instance: 
  {
    ...
    {
      var attributeDTO = this.getAttributeDTO('operations');
      var names = attributeDTO.getEnumNames();
      var enums = [];
      for(var i=0; i<names.length; i++)
      {
        enums.push(Mojo.$.com.runwaysdk.system.AllOperations[names[i]]);
      }
      return enums;
    },
    removeOperations : function(enumValue)
    {
      var attributeDTO = this.getAttributeDTO('operations');
    ...
    addOperations : function(enumValue)
    {
      var attributeDTO = this.getAttributeDTO('operations');
      attributeDTO.add(enumValue);
      this.setModified(true);
    },
    isOperationsReadable : function()
    {
      return this.getAttributeDTO('operations').isReadable();
    },
    isOperationsWritable : function()
    {
      return this.getAttributeDTO('operations').isWritable();
    },
    isOperationsModified : function()
    {
      return this.getAttributeDTO('operations').isModified();
    },
    getOperationsMd : function()
    {
      return this.getAttributeDTO('operations').getAttributeMdDTO();
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.TypePermissionQueryDTO', {
