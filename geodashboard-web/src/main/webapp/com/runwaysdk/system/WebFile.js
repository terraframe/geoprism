Mojo.Meta.newClass('com.runwaysdk.system.WebFile', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.system.WebFile'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('filePath').getValue();
    },
    setFilePath : function(value)
    {
      var attributeDTO = this.getAttributeDTO('filePath');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isFilePathReadable : function()
    {
      return this.getAttributeDTO('filePath').isReadable();
    },
    isFilePathWritable : function()
    {
      return this.getAttributeDTO('filePath').isWritable();
    },
    isFilePathModified : function()
    {
      return this.getAttributeDTO('filePath').isModified();
    },
    getFilePathMd : function()
    {
      return this.getAttributeDTO('filePath').getAttributeMdDTO();
    },
    getKeyName : function()
    {
...
Mojo.Meta.newClass('com.runwaysdk.system.WebFileQueryDTO', {
