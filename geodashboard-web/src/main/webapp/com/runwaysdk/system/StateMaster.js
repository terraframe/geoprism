...
Mojo.Meta.newClass('com.runwaysdk.system.StateMaster', {
  ...
  Constants : 
  {
    ...
    STATENAME : 'stateName',
    CLASS : 'com.runwaysdk.system.StateMaster'
  },
  Instance: 
  {
    ...
    {
      var attributeDTO = this.getAttributeDTO('entryState');
      var names = attributeDTO.getEnumNames();
      var enums = [];
      for(var i=0; i<names.length; i++)
      {
        enums.push(Mojo.$.com.runwaysdk.system.AllEntryEnumeration[names[i]]);
      }
      return enums;
    },
    removeEntryState : function(enumValue)
    {
      var attributeDTO = this.getAttributeDTO('entryState');
      attributeDTO.remove(enumValue);
      this.setModified(true);
    },
    clearEntryState : function()
    {
      var attributeDTO = this.getAttributeDTO('entryState');
      attributeDTO.clear();
      this.setModified(true);
    },
    addEntryState : function(enumValue)
    {
      var attributeDTO = this.getAttributeDTO('entryState');
      attributeDTO.add(enumValue);
      this.setModified(true);
    },
    isEntryStateReadable : function()
    {
      return this.getAttributeDTO('entryState').isReadable();
    },
    isEntryStateWritable : function()
    {
      return this.getAttributeDTO('entryState').isWritable();
    },
    isEntryStateModified : function()
    {
      return this.getAttributeDTO('entryState').isModified();
    },
    getEntryStateMd : function()
    {
      return this.getAttributeDTO('entryState').getAttributeMdDTO();
    },
    getStateName : function()
    {
      return this.getAttributeDTO('stateName').getValue();
    },
    setStateName : function(value)
    {
      var attributeDTO = this.getAttributeDTO('stateName');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isStateNameReadable : function()
    {
      return this.getAttributeDTO('stateName').isReadable();
    },
    isStateNameWritable : function()
    {
      return this.getAttributeDTO('stateName').isWritable();
    },
    isStateNameModified : function()
    {
      return this.getAttributeDTO('stateName').isModified();
    },
    getStateNameMd : function()
    {
      return this.getAttributeDTO('stateName').getAttributeMdDTO();
    },
    getAllSource : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParents(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    getAllSourceRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParentRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    addSource : function(clientRequest, parent)
    {
      var parentId = (parent instanceof Object) ? parent.getId() : parent;
      Mojo.$.com.runwaysdk.Facade.addParent(clientRequest, parentId, this.getId(), 'com.runwaysdk.system.Transition');
    },
    removeSource : function(clientRequest, relationship)
    {
      var relationshipId = (relationship instanceof Object) ? relationship.getId() : relationship;
      Mojo.$.com.runwaysdk.Facade.deleteParent(clientRequest, relationshipId);
    },
    removeAllSource : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.deleteParents(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    getAllSink : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    getAllSinkRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    addSink : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.Transition');
    },
    removeSink : function(clientRequest, relationship)
    {
        var relationshipId = (relationship instanceof Object) ? relationship.getId() : relationship;
      Mojo.$.com.runwaysdk.Facade.deleteChild(clientRequest, relationshipId);
    },
    removeAllSink : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.deleteChildren(clientRequest, this.getId(), 'com.runwaysdk.system.Transition');
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.StateMasterQueryDTO', {
