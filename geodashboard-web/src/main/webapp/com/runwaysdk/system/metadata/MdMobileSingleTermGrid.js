...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileSingleTermGrid', {
  Extends : 'com.runwaysdk.system.metadata.MdMobileAttribute',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdMobileSingleTermGrid'
  },
  Instance: 
  {
    getAllMdFields : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    getAllMdFieldsRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    addMdFields : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.MobileGridField');
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileSingleTermGridQueryDTO', {
