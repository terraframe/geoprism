...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileAttribute', {
  Extends : 'com.runwaysdk.system.metadata.MdMobileField',
  IsAbstract : true,
  Constants : 
  {
    DEFININGMDATTRIBUTE : 'definingMdAttribute',
    CLASS : 'com.runwaysdk.system.metadata.MdMobileAttribute'
  },
  Instance: 
  {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileAttributeQueryDTO', {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobilePrimitive', {
  Extends : 'com.runwaysdk.system.metadata.MdMobileAttribute',
  IsAbstract : true,
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdMobilePrimitive'
  },
  Instance: 
  {
    getAllGrid : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParents(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    getAllGridRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParentRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    addGrid : function(clientRequest, parent)
    {
      var parentId = (parent instanceof Object) ? parent.getId() : parent;
      Mojo.$.com.runwaysdk.Facade.addParent(clientRequest, parentId, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    ...
    {
      Mojo.$.com.runwaysdk.Facade.deleteParents(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.MobileGridField');
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobilePrimitiveQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.MdMobileAttributeQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdMobilePrimitive'
  },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileCharacterQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.MdMobilePrimitiveQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdMobileCharacter'
  },
