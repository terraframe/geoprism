...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdView', {
  Extends : 'com.runwaysdk.system.metadata.MdSession',
  Constants : 
  {
    QUERYBASECLASS : 'queryBaseClass',
    QUERYBASESOURCE : 'queryBaseSource',
    QUERYDTOCLASS : 'queryDTOclass',
    QUERYDTOSOURCE : 'queryDTOsource',
    QUERYSTUBCLASS : 'queryStubClass',
    QUERYSTUBSOURCE : 'queryStubSource',
    SUPERMDVIEW : 'superMdView',
    CLASS : 'com.runwaysdk.system.metadata.MdView'
  },
  Instance: 
  {
    getQueryBaseSource : function()
    {
      return this.getAttributeDTO('queryBaseSource').getValue();
    },
    isQueryBaseSourceReadable : function()
    {
      return this.getAttributeDTO('queryBaseSource').isReadable();
    },
    isQueryBaseSourceWritable : function()
    {
      return this.getAttributeDTO('queryBaseSource').isWritable();
    },
    isQueryBaseSourceModified : function()
    {
      return this.getAttributeDTO('queryBaseSource').isModified();
    },
    getQueryBaseSourceMd : function()
    {
      return this.getAttributeDTO('queryBaseSource').getAttributeMdDTO();
    },
    ...
    getQueryStubSource : function()
    {
      return this.getAttributeDTO('queryStubSource').getValue();
    },
    setQueryStubSource : function(value)
    {
      var attributeDTO = this.getAttributeDTO('queryStubSource');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isQueryStubSourceReadable : function()
    {
      return this.getAttributeDTO('queryStubSource').isReadable();
    },
    isQueryStubSourceWritable : function()
    {
      return this.getAttributeDTO('queryStubSource').isWritable();
    },
    isQueryStubSourceModified : function()
    {
      return this.getAttributeDTO('queryStubSource').isModified();
    },
    getQueryStubSourceMd : function()
    {
      return this.getAttributeDTO('queryStubSource').getAttributeMdDTO();
    },
    getSuperMdView : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('superMdView');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
    ...
    setSuperMdView : function(ref)
    {
      var attributeDTO = this.getAttributeDTO('superMdView');
      attributeDTO.setValue(Mojo.Util.isObject(ref) ? ref.getId() : ref);
      this.setModified(true);
    },
    isSuperMdViewReadable : function()
    {
      return this.getAttributeDTO('superMdView').isReadable();
    },
    isSuperMdViewWritable : function()
    {
      return this.getAttributeDTO('superMdView').isWritable();
    },
    isSuperMdViewModified : function()
    {
      return this.getAttributeDTO('superMdView').isModified();
    },
    getSuperMdViewMd : function()
    {
      return this.getAttributeDTO('superMdView').getAttributeMdDTO();
    },
    getAllParentView : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParents(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    getAllParentViewRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParentRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    addParentView : function(clientRequest, parent)
    {
      var parentId = (parent instanceof Object) ? parent.getId() : parent;
      Mojo.$.com.runwaysdk.Facade.addParent(clientRequest, parentId, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    removeParentView : function(clientRequest, relationship)
    {
      var relationshipId = (relationship instanceof Object) ? relationship.getId() : relationship;
      Mojo.$.com.runwaysdk.Facade.deleteParent(clientRequest, relationshipId);
    },
    removeAllParentView : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.deleteParents(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    getAllChildViews : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    getAllChildViewsRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    addChildViews : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    removeChildViews : function(clientRequest, relationship)
    {
        var relationshipId = (relationship instanceof Object) ? relationship.getId() : relationship;
      Mojo.$.com.runwaysdk.Facade.deleteChild(clientRequest, relationshipId);
    },
    removeAllChildViews : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.deleteChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ViewInheritance');
    },
    getAllVirtualAttribute : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ClassAttributeVirtual');
    },
    getAllVirtualAttributeRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.ClassAttributeVirtual');
    },
    addVirtualAttribute : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.ClassAttributeVirtual');
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdViewQueryDTO', {
