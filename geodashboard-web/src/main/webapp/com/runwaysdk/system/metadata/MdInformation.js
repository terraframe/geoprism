...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdInformation', {
  Extends : 'com.runwaysdk.system.metadata.MdMessage',
  Constants : 
  {
    SUPERMDINFORMATION : 'superMdInformation',
    CLASS : 'com.runwaysdk.system.metadata.MdInformation'
  },
  Instance: 
  {
    getSuperMdInformation : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('superMdInformation');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdInformationQueryDTO', {
