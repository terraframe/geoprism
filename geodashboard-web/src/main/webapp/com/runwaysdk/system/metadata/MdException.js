...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdException', {
  Extends : 'com.runwaysdk.system.metadata.MdLocalizable',
  Constants : 
  {
    SUPERMDEXCEPTION : 'superMdException',
    CLASS : 'com.runwaysdk.system.metadata.MdException'
  },
  Instance: 
  {
    getSuperMdException : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('superMdException');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdExceptionQueryDTO', {
