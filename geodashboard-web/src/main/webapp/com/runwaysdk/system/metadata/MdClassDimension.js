...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdClassDimension', {
  Extends : 'com.runwaysdk.system.metadata.Metadata',
  Constants : 
  {
    DEFININGMDCLASS : 'definingMdClass',
    DEFININGMDDIMENSION : 'definingMdDimension',
    CLASS : 'com.runwaysdk.system.metadata.MdClassDimension'
  },
  Instance: 
  {
    ...
    getDefiningMdDimension : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('definingMdDimension');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdClassDimensionQueryDTO', {
