...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMethod', {
  ...
  Constants : 
  {
    ...
    CLASS : 'com.runwaysdk.system.metadata.MdMethod'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('isStatic').getValue();
    },
    setIsStatic : function(value)
    {
      var attributeDTO = this.getAttributeDTO('isStatic');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isIsStaticReadable : function()
    {
      return this.getAttributeDTO('isStatic').isReadable();
    },
    isIsStaticWritable : function()
    {
      return this.getAttributeDTO('isStatic').isWritable();
    },
    isIsStaticModified : function()
    {
      return this.getAttributeDTO('isStatic').isModified();
    },
    getIsStaticMd : function()
    {
      return this.getAttributeDTO('isStatic').getAttributeMdDTO();
    },
    getMdType : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('mdType');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMethodQueryDTO', {
