...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebSingleTermGrid', {
  Extends : 'com.runwaysdk.system.metadata.MdWebAttribute',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdWebSingleTermGrid'
  },
  Instance: 
  {
    getAllMdFields : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.WebGridField');
    },
    getAllMdFieldsRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.WebGridField');
    },
    addMdFields : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.WebGridField');
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebSingleTermGridQueryDTO', {
