Mojo.Meta.newClass('com.runwaysdk.system.metadata.MetadataRelationship', {
  Extends : 'com.runwaysdk.business.RelationshipDTO',
  IsAbstract : true,
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.system.metadata.MetadataRelationship'
  },
  Instance: 
  {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MetadataRelationshipQueryDTO', {
  Extends : 'com.runwaysdk.business.RelationshipQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MetadataRelationship'
  },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.IndexAttribute', {
  Extends : 'com.runwaysdk.system.metadata.MetadataRelationship',
  Constants : 
  {
    INDEXORDER : 'indexOrder',
    CLASS : 'com.runwaysdk.system.metadata.IndexAttribute'
  },
  Instance: 
  {
    getIndexOrder : function()
    {
      return this.getAttributeDTO('indexOrder').getValue();
    },
    setIndexOrder : function(value)
    {
      var attributeDTO = this.getAttributeDTO('indexOrder');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isIndexOrderReadable : function()
    {
      return this.getAttributeDTO('indexOrder').isReadable();
    },
    isIndexOrderWritable : function()
    {
      return this.getAttributeDTO('indexOrder').isWritable();
    },
    isIndexOrderModified : function()
    {
      return this.getAttributeDTO('indexOrder').isModified();
    },
    getIndexOrderMd : function()
    {
      return this.getAttributeDTO('indexOrder').getAttributeMdDTO();
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.IndexAttributeQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.MetadataRelationshipQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.IndexAttribute'
  },
