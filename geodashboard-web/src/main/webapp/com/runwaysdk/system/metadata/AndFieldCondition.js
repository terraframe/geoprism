...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.CompositeFieldCondition', {
  ...
  Constants : 
  {
    ...
    CLASS : 'com.runwaysdk.system.metadata.CompositeFieldCondition'
  },
  Instance: 
  {
    getFirstCondition : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('firstCondition');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
    ...
    setFirstCondition : function(ref)
    {
      var attributeDTO = this.getAttributeDTO('firstCondition');
      attributeDTO.setValue(Mojo.Util.isObject(ref) ? ref.getId() : ref);
      this.setModified(true);
    },
    isFirstConditionReadable : function()
    {
      return this.getAttributeDTO('firstCondition').isReadable();
    },
    isFirstConditionWritable : function()
    {
      return this.getAttributeDTO('firstCondition').isWritable();
    },
    isFirstConditionModified : function()
    {
      return this.getAttributeDTO('firstCondition').isModified();
    },
    getFirstConditionMd : function()
    {
      return this.getAttributeDTO('firstCondition').getAttributeMdDTO();
    },
    getSecondCondition : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('secondCondition');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
    ...
    setSecondCondition : function(ref)
    {
      var attributeDTO = this.getAttributeDTO('secondCondition');
      attributeDTO.setValue(Mojo.Util.isObject(ref) ? ref.getId() : ref);
      this.setModified(true);
    },
    isSecondConditionReadable : function()
    {
      return this.getAttributeDTO('secondCondition').isReadable();
    },
    isSecondConditionWritable : function()
    {
      return this.getAttributeDTO('secondCondition').isWritable();
    },
    isSecondConditionModified : function()
    {
      return this.getAttributeDTO('secondCondition').isModified();
    },
    getSecondConditionMd : function()
    {
      return this.getAttributeDTO('secondCondition').getAttributeMdDTO();
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.CompositeFieldConditionQueryDTO', {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.AndFieldCondition', {
  Extends : 'com.runwaysdk.system.metadata.CompositeFieldCondition',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.AndFieldCondition'
  },
  Instance: 
  {
    initialize : function(obj)
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.AndFieldConditionQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.CompositeFieldConditionQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.AndFieldCondition'
  },
