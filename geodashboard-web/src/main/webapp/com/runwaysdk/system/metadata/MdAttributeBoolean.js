...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeBoolean', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributePrimitive',
  Constants : 
  {
    DEFAULTVALUE : 'defaultValue',
    NEGATIVEDISPLAYLABEL : 'negativeDisplayLabel',
    POSITIVEDISPLAYLABEL : 'positiveDisplayLabel',
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeBoolean'
  },
  Instance: 
  {
    ...
    getNegativeDisplayLabel : function()
    {
      if(Mojo.Meta.classExists('com.runwaysdk.system.metadata.MetadataDisplayLabel'))
      {
        var structDTO = this.getAttributeDTO('negativeDisplayLabel').getStructDTO();
        if(structDTO == null)
        {
          return null;
        }
        ...
        {
          structDTO = new Mojo.$.com.runwaysdk.system.metadata.MetadataDisplayLabel(structDTO);
          this.getAttributeDTO('negativeDisplayLabel').setStructDTO(structDTO);
          return structDTO;
        }
      }
      else
    ...
    isNegativeDisplayLabelReadable : function()
    {
      return this.getAttributeDTO('negativeDisplayLabel').isReadable();
    },
    isNegativeDisplayLabelWritable : function()
    {
      return this.getAttributeDTO('negativeDisplayLabel').isWritable();
    },
    isNegativeDisplayLabelModified : function()
    {
      return this.getAttributeDTO('negativeDisplayLabel').isModified();
    },
    getNegativeDisplayLabelMd : function()
    {
      return this.getAttributeDTO('negativeDisplayLabel').getAttributeMdDTO();
    },
    getPositiveDisplayLabel : function()
    {
      if(Mojo.Meta.classExists('com.runwaysdk.system.metadata.MetadataDisplayLabel'))
      {
        var structDTO = this.getAttributeDTO('positiveDisplayLabel').getStructDTO();
        if(structDTO == null)
        {
          return null;
        }
        ...
        {
          structDTO = new Mojo.$.com.runwaysdk.system.metadata.MetadataDisplayLabel(structDTO);
          this.getAttributeDTO('positiveDisplayLabel').setStructDTO(structDTO);
          return structDTO;
        }
      }
      else
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeBooleanQueryDTO', {
