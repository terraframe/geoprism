...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeEnumeration', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributeRef',
  Constants : 
  {
    CACHECOLUMNNAME : 'cacheColumnName',
    DEFAULTVALUE : 'defaultValue',
    MDENUMERATION : 'mdEnumeration',
    SELECTMULTIPLE : 'selectMultiple',
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeEnumeration'
  },
  Instance: 
  {
    getCacheColumnName : function()
    {
      return this.getAttributeDTO('cacheColumnName').getValue();
    },
    isCacheColumnNameReadable : function()
    {
      return this.getAttributeDTO('cacheColumnName').isReadable();
    },
    isCacheColumnNameWritable : function()
    {
      return this.getAttributeDTO('cacheColumnName').isWritable();
    },
    isCacheColumnNameModified : function()
    {
      return this.getAttributeDTO('cacheColumnName').isModified();
    },
    getCacheColumnNameMd : function()
    {
      return this.getAttributeDTO('cacheColumnName').getAttributeMdDTO();
    },
    ...
    getMdEnumeration : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('mdEnumeration');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeEnumerationQueryDTO', {
