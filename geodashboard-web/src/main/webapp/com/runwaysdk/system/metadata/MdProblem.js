...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdProblem', {
  Extends : 'com.runwaysdk.system.metadata.MdNotification',
  Constants : 
  {
    SUPERMDPROBLEM : 'superMdProblem',
    CLASS : 'com.runwaysdk.system.metadata.MdProblem'
  },
  Instance: 
  {
    getSuperMdProblem : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('superMdProblem');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdProblemQueryDTO', {
