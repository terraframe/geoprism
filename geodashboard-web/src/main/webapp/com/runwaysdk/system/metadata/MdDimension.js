...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdDimension', {
  Extends : 'com.runwaysdk.system.metadata.Metadata',
  Constants : 
  {
    DISPLAYLABEL : 'displayLabel',
    NAME : 'name',
    CLASS : 'com.runwaysdk.system.metadata.MdDimension'
  },
  Instance: 
  {
    ...
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.DimensionHasClass');
    },
    getAllMdClassDimensionsRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.DimensionHasClass');
    },
    addMdClassDimensions : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.DimensionHasClass');
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdDimensionQueryDTO', {
