...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdIndex', {
  ...
  Constants : 
  {
    ...
    CLASS : 'com.runwaysdk.system.metadata.MdIndex'
  },
  Instance: 
  {
    getActive : function()
    {
      return this.getAttributeDTO('active').getValue();
    },
    setActive : function(value)
    {
      var attributeDTO = this.getAttributeDTO('active');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isActiveReadable : function()
    {
      return this.getAttributeDTO('active').isReadable();
    },
    isActiveWritable : function()
    {
      return this.getAttributeDTO('active').isWritable();
    },
    isActiveModified : function()
    {
      return this.getAttributeDTO('active').isModified();
    },
    getActiveMd : function()
    {
      return this.getAttributeDTO('active').getAttributeMdDTO();
    },
    ...
    getMdEntity : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('mdEntity');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdIndexQueryDTO', {
