...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebHeader', {
  Extends : 'com.runwaysdk.system.metadata.MdWebField',
  Constants : 
  {
    HEADERTEXT : 'headerText',
    CLASS : 'com.runwaysdk.system.metadata.MdWebHeader'
  },
  Instance: 
  {
    getHeaderText : function()
    {
      if(Mojo.Meta.classExists('com.runwaysdk.system.metadata.MdWebHeaderHeaderText'))
      {
        ...
        else if(structDTO instanceof Mojo.$.com.runwaysdk.system.metadata.MdWebHeaderHeaderText)
        {
          return structDTO;
        }
        else
        {
          structDTO = new Mojo.$.com.runwaysdk.system.metadata.MdWebHeaderHeaderText(structDTO);
      ...
      {
        throw new Mojo.$.com.runwaysdk.Exception('Must import type com.runwaysdk.system.metadata.MdWebHeaderHeaderText');
      }
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebHeaderQueryDTO', {
