...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeNumber', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributePrimitive',
  IsAbstract : true,
  Constants : 
  {
    REJECTNEGATIVE : 'rejectNegative',
    REJECTPOSITIVE : 'rejectPositive',
    REJECTZERO : 'rejectZero',
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeNumber'
  },
  Instance: 
  {
    getRejectNegative : function()
    {
      return this.getAttributeDTO('rejectNegative').getValue();
    },
    setRejectNegative : function(value)
    {
      var attributeDTO = this.getAttributeDTO('rejectNegative');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isRejectNegativeReadable : function()
    {
      return this.getAttributeDTO('rejectNegative').isReadable();
    },
    isRejectNegativeWritable : function()
    {
      return this.getAttributeDTO('rejectNegative').isWritable();
    },
    isRejectNegativeModified : function()
    {
      return this.getAttributeDTO('rejectNegative').isModified();
    },
    getRejectNegativeMd : function()
    {
      return this.getAttributeDTO('rejectNegative').getAttributeMdDTO();
    },
    getRejectPositive : function()
    {
      return this.getAttributeDTO('rejectPositive').getValue();
    },
    setRejectPositive : function(value)
    {
      var attributeDTO = this.getAttributeDTO('rejectPositive');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isRejectPositiveReadable : function()
    {
      return this.getAttributeDTO('rejectPositive').isReadable();
    },
    isRejectPositiveWritable : function()
    {
      return this.getAttributeDTO('rejectPositive').isWritable();
    },
    isRejectPositiveModified : function()
    {
      return this.getAttributeDTO('rejectPositive').isModified();
    },
    getRejectPositiveMd : function()
    {
      return this.getAttributeDTO('rejectPositive').getAttributeMdDTO();
    },
    getRejectZero : function()
    {
      return this.getAttributeDTO('rejectZero').getValue();
    },
    setRejectZero : function(value)
    {
      var attributeDTO = this.getAttributeDTO('rejectZero');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isRejectZeroReadable : function()
    {
      return this.getAttributeDTO('rejectZero').isReadable();
    },
    isRejectZeroWritable : function()
    {
      return this.getAttributeDTO('rejectZero').isWritable();
    },
    isRejectZeroModified : function()
    {
      return this.getAttributeDTO('rejectZero').isModified();
    },
    getRejectZeroMd : function()
    {
      return this.getAttributeDTO('rejectZero').getAttributeMdDTO();
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeNumberQueryDTO', {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeDec', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributeNumber',
  IsAbstract : true,
  Constants : 
  {
    DATABASEDECIMAL : 'databaseDecimal',
    DATABASELENGTH : 'databaseLength',
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeDec'
  },
  Instance: 
  {
    getDatabaseDecimal : function()
    {
      return this.getAttributeDTO('databaseDecimal').getValue();
    },
    setDatabaseDecimal : function(value)
    {
      var attributeDTO = this.getAttributeDTO('databaseDecimal');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isDatabaseDecimalReadable : function()
    {
      return this.getAttributeDTO('databaseDecimal').isReadable();
    },
    isDatabaseDecimalWritable : function()
    {
      return this.getAttributeDTO('databaseDecimal').isWritable();
    },
    isDatabaseDecimalModified : function()
    {
      return this.getAttributeDTO('databaseDecimal').isModified();
    },
    getDatabaseDecimalMd : function()
    {
      return this.getAttributeDTO('databaseDecimal').getAttributeMdDTO();
    },
    getDatabaseLength : function()
    {
      return this.getAttributeDTO('databaseLength').getValue();
    },
    setDatabaseLength : function(value)
    {
      var attributeDTO = this.getAttributeDTO('databaseLength');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isDatabaseLengthReadable : function()
    {
      return this.getAttributeDTO('databaseLength').isReadable();
    },
    isDatabaseLengthWritable : function()
    {
      return this.getAttributeDTO('databaseLength').isWritable();
    },
    isDatabaseLengthModified : function()
    {
      return this.getAttributeDTO('databaseLength').isModified();
    },
    getDatabaseLengthMd : function()
    {
      return this.getAttributeDTO('databaseLength').getAttributeMdDTO();
    },
    initialize : function(obj)
    {
      this.$initialize(obj);
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeDecQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributeNumberQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeDec'
  },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeFloat', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributeDec',
  Constants : 
  {
    DEFAULTVALUE : 'defaultValue',
    ENDRANGE : 'endRange',
    STARTRANGE : 'startRange',
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeFloat'
  },
  Instance: 
  {
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdAttributeFloatQueryDTO', {
  Extends : 'com.runwaysdk.system.metadata.MdAttributeDecQueryDTO',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdAttributeFloat'
  },
