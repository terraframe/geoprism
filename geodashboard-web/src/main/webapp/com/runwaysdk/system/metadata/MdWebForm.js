...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebForm', {
  Extends : 'com.runwaysdk.system.metadata.MdForm',
  Constants : 
  {
    CLASS : 'com.runwaysdk.system.metadata.MdWebForm'
  },
  Instance: 
  {
    getOrderedMdFields : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.system.metadata.MdWebForm', methodName:'getOrderedMdFields', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, this, [].splice.call(arguments, 1));
    },
    getAllMdFields : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.WebFormField');
    },
    getAllMdFieldsRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.system.metadata.WebFormField');
    },
    addMdFields : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.system.metadata.WebFormField');
    },
    removeMdFields : function(clientRequest, relationship)
    {
        var relationshipId = (relationship instanceof Object) ? relationship.getId() : relationship;
  ...
  Static: 
  {
    getOrderedMdFields : function(clientRequest, id)
    {
      var metadata = {className:'com.runwaysdk.system.metadata.MdWebForm', methodName:'getOrderedMdFields', declaredTypes: ["java.lang.String"]};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    }
  }
});
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdWebFormQueryDTO', {
