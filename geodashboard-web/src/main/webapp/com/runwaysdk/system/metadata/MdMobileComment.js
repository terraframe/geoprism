...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileComment', {
  Extends : 'com.runwaysdk.system.metadata.MdMobileField',
  Constants : 
  {
    COMMENTTEXT : 'commentText',
    CLASS : 'com.runwaysdk.system.metadata.MdMobileComment'
  },
  Instance: 
  {
    getCommentText : function()
    {
      if(Mojo.Meta.classExists('com.runwaysdk.system.metadata.MdMobileCommentCommentText'))
      {
        ...
        else if(structDTO instanceof Mojo.$.com.runwaysdk.system.metadata.MdMobileCommentCommentText)
        {
          return structDTO;
        }
        else
        {
          structDTO = new Mojo.$.com.runwaysdk.system.metadata.MdMobileCommentCommentText(structDTO);
      ...
      {
        throw new Mojo.$.com.runwaysdk.Exception('Must import type com.runwaysdk.system.metadata.MdMobileCommentCommentText');
      }
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.MdMobileCommentQueryDTO', {
