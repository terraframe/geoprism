...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.EntityCacheMaster', {
  Extends : 'com.runwaysdk.system.EnumerationMaster',
  Constants : 
  {
    CACHECODE : 'cacheCode',
    DESCRIPTION : 'description',
    CLASS : 'com.runwaysdk.system.metadata.EntityCacheMaster'
  },
  Instance: 
  {
    getCacheCode : function()
    {
      return this.getAttributeDTO('cacheCode').getValue();
    },
    isCacheCodeReadable : function()
    {
      return this.getAttributeDTO('cacheCode').isReadable();
    },
    isCacheCodeWritable : function()
    {
      return this.getAttributeDTO('cacheCode').isWritable();
    },
    isCacheCodeModified : function()
    {
      return this.getAttributeDTO('cacheCode').isModified();
    },
    getCacheCodeMd : function()
    {
      return this.getAttributeDTO('cacheCode').getAttributeMdDTO();
    },
    getDescription : function()
    {
      return this.getAttributeDTO('description').getValue();
    },
    setDescription : function(value)
    {
      var attributeDTO = this.getAttributeDTO('description');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
...
Mojo.Meta.newClass('com.runwaysdk.system.metadata.EntityCacheMasterQueryDTO', {
