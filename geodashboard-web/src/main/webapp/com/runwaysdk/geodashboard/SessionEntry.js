Mojo.Meta.newClass('com.runwaysdk.geodashboard.SessionEntry', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.geodashboard.SessionEntry'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('sessionId').getValue();
    },
    setSessionId : function(value)
    {
      var attributeDTO = this.getAttributeDTO('sessionId');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isSessionIdReadable : function()
    {
      return this.getAttributeDTO('sessionId').isReadable();
    },
    isSessionIdWritable : function()
    {
      return this.getAttributeDTO('sessionId').isWritable();
    },
    isSessionIdModified : function()
    {
      return this.getAttributeDTO('sessionId').isModified();
    },
    getSessionIdMd : function()
    {
      return this.getAttributeDTO('sessionId').getAttributeMdDTO();
    },
    getSessionUser : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('sessionUser');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
    ...
    setSessionUser : function(ref)
    {
      var attributeDTO = this.getAttributeDTO('sessionUser');
      attributeDTO.setValue(Mojo.Util.isObject(ref) ? ref.getId() : ref);
      this.setModified(true);
    },
    isSessionUserReadable : function()
    {
      return this.getAttributeDTO('sessionUser').isReadable();
    },
    isSessionUserWritable : function()
    {
      return this.getAttributeDTO('sessionUser').isWritable();
    },
    isSessionUserModified : function()
    {
      return this.getAttributeDTO('sessionUser').isModified();
    },
    getSessionUserMd : function()
    {
      return this.getAttributeDTO('sessionUser').getAttributeMdDTO();
    },
    ...
    getAllDashboardMap : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildren(clientRequest, this.getId(), 'com.runwaysdk.geodashboard.gis.persist.SessionMap');
    },
    getAllDashboardMapRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getChildRelationships(clientRequest, this.getId(), 'com.runwaysdk.geodashboard.gis.persist.SessionMap');
    },
    addDashboardMap : function(clientRequest, child)
    {
      var childId = (child instanceof Object) ? child.getId() : child;
      Mojo.$.com.runwaysdk.Facade.addChild(clientRequest, this.getId(), childId, 'com.runwaysdk.geodashboard.gis.persist.SessionMap');
    },
    removeDashboardMap : function(clientRequest, relationship)
    {
  ...
  Static: 
  {
    deleteByUser : function(clientRequest, user)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteByUser', declaredTypes: ["com.runwaysdk.system.Users"]};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteMapsForSession : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteMapsForSession', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteBySession : function(clientRequest, sessionId)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteBySession', declaredTypes: ["java.lang.String"]};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteAll : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteAll', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteMapForSession : function(clientRequest, mapId)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteMapForSession', declaredTypes: ["java.lang.String"]};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    createMapForSession : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'createMapForSession', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteByCurrentUser : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteByCurrentUser', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    },
    deleteByCurrentSession : function(clientRequest)
    {
      var metadata = {className:'com.runwaysdk.geodashboard.SessionEntry', methodName:'deleteByCurrentSession', declaredTypes: []};
      Mojo.$.com.runwaysdk.Facade.invokeMethod(clientRequest, metadata, null, [].splice.call(arguments, 1));
    }
  }
});
Mojo.Meta.newClass('com.runwaysdk.geodashboard.SessionEntryQueryDTO', {
