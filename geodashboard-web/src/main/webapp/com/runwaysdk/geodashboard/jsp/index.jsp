...
<script type="text/javascript" >
	...
	$(document).ready(function(){			
		if (window.location.hash.length > 0) {
			...
			$("#main").html('<iframe id="main-content-frame" scrolling="no" seamless sandbox="allow-same-origin allow-top-navigation allow-scripts allow-popups allow-forms" src='+window.location.hash.substring(1)+'></iframe>');
		}
		else {	
			
			//// Add main page if no hash exists
			$("#main").html('<iframe id="main-content-frame" scrolling="no" seamless sandbox="allow-same-origin allow-top-navigation allow-scripts allow-popups allow-forms" src="<%out.print(webappRoot);%>com/runwaysdk/geodashboard/jsp/mainContent.jsp"></iframe>');			
		}
