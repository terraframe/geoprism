...
(function(){
  ...
  /**
   * @class com.runwaysdk.ui.datatable.ViewQueryDataSource A data source for data tables that reads instance data from a query dto.
   * 
   * @constructs
   * @param obj
   *   @param com.runwaysdk.business.ViewQueryDTO queryDTO The query dto to display data from.
   */
  var queryDataSource = ClassFramework.newClass('com.runwaysdk.ui.datatable.datasource.ViewQueryDataSource', {
    ...
    Instance : {
      initialize : function(config) {
        ...
        if (config.columns == null && !config.readColumnsFromMetadata) {
          throw new com.runwaysdk.Exception("ViewQueryDataSource has not been configured correctly. Either a columns array of objects or a boolean flag readColumnsFromMetadata (set to true) must be present.");
        }
...
//          }
      ...
      _performQuery : function(callback) {
        ...
        com.runwaysdk.Facade.queryViews(clientRequest, this._metadataQueryDTO);
      },
