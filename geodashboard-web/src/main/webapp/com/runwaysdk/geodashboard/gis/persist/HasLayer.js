Mojo.Meta.newClass('com.runwaysdk.geodashboard.gis.persist.HasLayer', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.geodashboard.gis.persist.HasLayer'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('layerIndex').getValue();
    },
    setLayerIndex : function(value)
    {
      var attributeDTO = this.getAttributeDTO('layerIndex');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isLayerIndexReadable : function()
    {
      return this.getAttributeDTO('layerIndex').isReadable();
    },
    isLayerIndexWritable : function()
    {
      return this.getAttributeDTO('layerIndex').isWritable();
    },
    isLayerIndexModified : function()
    {
      return this.getAttributeDTO('layerIndex').isModified();
    },
    getLayerIndexMd : function()
    {
      return this.getAttributeDTO('layerIndex').getAttributeMdDTO();
    },
...
Mojo.Meta.newClass('com.runwaysdk.geodashboard.gis.persist.HasLayerQueryDTO', {
