Mojo.Meta.newClass('com.runwaysdk.geodashboard.DashboardAttributes', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.geodashboard.DashboardAttributes'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('listOrder').getValue();
    },
    setListOrder : function(value)
    {
      var attributeDTO = this.getAttributeDTO('listOrder');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isListOrderReadable : function()
    {
      return this.getAttributeDTO('listOrder').isReadable();
    },
    isListOrderWritable : function()
    {
      return this.getAttributeDTO('listOrder').isWritable();
    },
    isListOrderModified : function()
    {
      return this.getAttributeDTO('listOrder').isModified();
    },
    getListOrderMd : function()
    {
      return this.getAttributeDTO('listOrder').getAttributeMdDTO();
    },
...
Mojo.Meta.newClass('com.runwaysdk.geodashboard.DashboardAttributesQueryDTO', {
