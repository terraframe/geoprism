Mojo.Meta.newClass('com.runwaysdk.geodashboard.AttributeWrapper', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    WRAPPEDMDATTRIBUTE : 'wrappedMdAttribute',
    CLASS : 'com.runwaysdk.geodashboard.AttributeWrapper'
  },
  Instance: 
  {
    ...
    getWrappedMdAttribute : function(clientRequest)
    {
      var attributeDTO = this.getAttributeDTO('wrappedMdAttribute');
      var value = attributeDTO.getValue();
      if(value == null || value == '')
      {
        clientRequest.onSuccess(null);
    ...
    setWrappedMdAttribute : function(ref)
    {
      var attributeDTO = this.getAttributeDTO('wrappedMdAttribute');
      attributeDTO.setValue(Mojo.Util.isObject(ref) ? ref.getId() : ref);
      this.setModified(true);
    },
    isWrappedMdAttributeReadable : function()
    {
      return this.getAttributeDTO('wrappedMdAttribute').isReadable();
    },
    isWrappedMdAttributeWritable : function()
    {
      return this.getAttributeDTO('wrappedMdAttribute').isWritable();
    },
    isWrappedMdAttributeModified : function()
    {
      return this.getAttributeDTO('wrappedMdAttribute').isModified();
    },
    getWrappedMdAttributeMd : function()
    {
      return this.getAttributeDTO('wrappedMdAttribute').getAttributeMdDTO();
    },
    getAllDashboardMetadata : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParents(clientRequest, this.getId(), 'com.runwaysdk.geodashboard.DashboardAttributes');
    },
    getAllDashboardMetadataRelationships : function(clientRequest)
    {
      Mojo.$.com.runwaysdk.Facade.getParentRelationships(clientRequest, this.getId(), 'com.runwaysdk.geodashboard.DashboardAttributes');
    },
    addDashboardMetadata : function(clientRequest, parent)
    {
      var parentId = (parent instanceof Object) ? parent.getId() : parent;
      Mojo.$.com.runwaysdk.Facade.addParent(clientRequest, parentId, this.getId(), 'com.runwaysdk.geodashboard.DashboardAttributes');
    },
    removeDashboardMetadata : function(clientRequest, relationship)
    {
...
Mojo.Meta.newClass('com.runwaysdk.geodashboard.AttributeWrapperQueryDTO', {
