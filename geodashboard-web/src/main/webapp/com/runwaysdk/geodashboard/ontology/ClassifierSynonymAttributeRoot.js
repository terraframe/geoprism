Mojo.Meta.newClass('com.runwaysdk.geodashboard.ontology.ClassifierSynonymAttributeRoot', {
  ...
  Constants : 
  {
    ...
    TYPE : 'type',
    CLASS : 'com.runwaysdk.geodashboard.ontology.ClassifierSynonymAttributeRoot'
  },
  Instance: 
  {
    ...
    {
      return this.getAttributeDTO('selectable').getValue();
    },
    setSelectable : function(value)
    {
      var attributeDTO = this.getAttributeDTO('selectable');
      attributeDTO.setValue(value);
      this.setModified(true);
    },
    isSelectableReadable : function()
    {
      return this.getAttributeDTO('selectable').isReadable();
    },
    isSelectableWritable : function()
    {
      return this.getAttributeDTO('selectable').isWritable();
    },
    isSelectableModified : function()
    {
      return this.getAttributeDTO('selectable').isModified();
    },
    getSelectableMd : function()
    {
      return this.getAttributeDTO('selectable').getAttributeMdDTO();
    },
    getSeq : function()
    {
...
Mojo.Meta.newClass('com.runwaysdk.geodashboard.ontology.ClassifierSynonymAttributeRootQueryDTO', {
