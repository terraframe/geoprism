...
<div class="row-holder" style="display:none">
  ...
  <div class="holder">
    <div id="layer-type-styler-container" class="tab-content"> 
        ...
        <div class="fill-block">
          ...
          <div class="cell-holder">
            ...
            <div class="cell">
              ...
              <div class="text">
                <select id="basic-point-opacity-select" class="tab-select" name="style.pointOpacity" ng-options="getFormattedInt(n) for n in [] | decimalrange:0:101 track by n" ng-model="thematicStyleModel.pointOpacity">
                </select>
              </div>
            </div>
          </div>
      ...
      <style-stroke point-stroke="thematicStyleModel.pointStroke" point-stroke-width="thematicStyleModel.pointStrokeWidth" point-stroke-opacity="thematicStyleModel.pointStrokeOpacity"></style-stroke>
        ...
        <div class="cell-holder">
          ...
          <div class="cell">
            ...
            <div class="select-holder">
              <select name="style.pointStrokeWidth" id="basic-point-stroke-select" class="tab-select" ng-options="n for n in [] | intrange:1:16" ng-model="thematicStyleModel.pointStrokeWidth"></select>
            </div>
          </div>
          <div class="cell">
            <label for="basic-point-stroke-opacity-select"><gdb:localize key="DashboardLayer.form.opacity"/></label>
            <div class="text">
              <select id="basic-point-stroke-opacity-select" class="tab-select" name="style.pointStrokeOpacity" ng-options="getFormattedInt(n) for n in [] | decimalrange:0:101 track by n" ng-model="thematicStyleModel.pointStrokeOpacity"></select>
            </div>
          </div>
        </div>
      </div>
