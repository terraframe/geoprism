...
@com.runwaysdk.business.ClassSignature(hash = -1858934656)
/**
...
public abstract class UserNotFoundExceptionBase extends com.runwaysdk.business.SmartException
{
  ...
  private static final long serialVersionUID = -1858934656;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.session.UserNotFoundException.CLASS);
