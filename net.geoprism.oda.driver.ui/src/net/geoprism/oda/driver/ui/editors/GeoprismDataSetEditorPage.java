...
import net.geoprism.oda.driver.ui.provider.ConnectionException;
import net.geoprism.oda.driver.ui.provider.GeodashboardMetaDataProvider;
import net.geoprism.oda.driver.ui.provider.LabelValuePair;
import net.geoprism.oda.driver.ui.provider.QueryFacadeUtil;
...
public class GeoprismDataSetEditorPage extends DataSetWizardPage implements ISelectionChangedListener
{
  ...
  private Control createPageControl(Composite parent)
  {
    ...
    try
    {
      ...
      schemaLabel.setText(GeoprismPlugin.getResourceString("dashboardpage.label.selectdashboard")); //$NON-NLS-1$
      ...
      geoNodeLabel.setText(GeoprismPlugin.getResourceString("dashboardpage.label.geoNode")); //$NON-NLS-1$
      ...
      aggregationLabel.setText(GeoprismPlugin.getResourceString("dashboardpage.label.aggregation")); //$NON-NLS-1$
    ...
    catch (ConnectionException ex)
    {
      ...
      String label = GeoprismPlugin.getResourceString("dataset.error"); //$NON-NLS-1$
      String message = GeoprismPlugin.getResourceString("dashboardpage.label.connectionerror"); //$NON-NLS-1$
