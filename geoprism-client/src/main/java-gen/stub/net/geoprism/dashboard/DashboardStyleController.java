...
import net.geoprism.dashboard.DashboardStyleControllerBase;
...
public class DashboardStyleController extends DashboardStyleControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    net.geoprism.dashboard.DashboardStyleDTO dto = net.geoprism.dashboard.DashboardStyleDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.DashboardStyleDTO.get(clientRequest, id));
