...
public class DashboardLayerNameLabelController extends DashboardLayerNameLabelControllerBase 
{
  ...
  {
    net.geoprism.dashboard.layer.DashboardLayerNameLabelDTO dto = net.geoprism.dashboard.layer.DashboardLayerNameLabelDTO.get(super.getClientRequest(), oid);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.layer.DashboardLayerNameLabelDTO.get(clientRequest, oid));
