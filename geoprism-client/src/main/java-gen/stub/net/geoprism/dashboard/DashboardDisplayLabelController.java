...
import net.geoprism.dashboard.DashboardDisplayLabelControllerBase;
...
public class DashboardDisplayLabelController extends DashboardDisplayLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    net.geoprism.dashboard.DashboardDisplayLabelDTO dto = net.geoprism.dashboard.DashboardDisplayLabelDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.DashboardDisplayLabelDTO.get(clientRequest, id));
