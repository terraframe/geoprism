...
public class MetadataWrapperController extends MetadataWrapperControllerBase 
{
  public static final String JSP_DIR = "/WEB-INF/net/geoprism/dashboard/MetadataWrapper/";
  ...
  {
    net.geoprism.dashboard.MetadataWrapperDTO dto = net.geoprism.dashboard.MetadataWrapperDTO.lock(super.getClientRequest(), oid);
    req.setAttribute("_mdClass", com.runwaysdk.system.metadata.MdClassDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    net.geoprism.dashboard.MetadataWrapperDTO dto = new net.geoprism.dashboard.MetadataWrapperDTO(clientRequest);
    req.setAttribute("_mdClass", com.runwaysdk.system.metadata.MdClassDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  public void view(java.lang.String oid) throws java.io.IOException, javax.servlet.ServletException
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("_mdClass", com.runwaysdk.system.metadata.MdClassDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", net.geoprism.dashboard.MetadataWrapperDTO.get(clientRequest, oid));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.MetadataWrapperQueryDTO query = net.geoprism.dashboard.MetadataWrapperDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.MetadataWrapperQueryDTO query = net.geoprism.dashboard.MetadataWrapperDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
