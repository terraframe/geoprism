...
public class DashboardAttributesController extends DashboardAttributesControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    req.setAttribute("parentList", net.geoprism.dashboard.MetadataWrapperDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("childList", net.geoprism.dashboard.AttributeWrapperDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.DashboardAttributesQueryDTO query = net.geoprism.dashboard.DashboardAttributesDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.DashboardAttributesQueryDTO query = net.geoprism.dashboard.DashboardAttributesDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
