...
public class AggregationTypeController extends AggregationTypeControllerBase 
{
  ...
  {
    net.geoprism.dashboard.AggregationTypeDTO dto = net.geoprism.dashboard.AggregationTypeDTO.lock(super.getClientRequest(), oid);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    net.geoprism.dashboard.AggregationTypeDTO dto = new net.geoprism.dashboard.AggregationTypeDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.AggregationTypeDTO.get(clientRequest, oid));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.AggregationTypeQueryDTO query = net.geoprism.dashboard.AggregationTypeDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.AggregationTypeQueryDTO query = net.geoprism.dashboard.AggregationTypeDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
