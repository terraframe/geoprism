...
public class AggregationTypeController extends AggregationTypeControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    net.geoprism.dashboard.AggregationTypeDTO dto = net.geoprism.dashboard.AggregationTypeDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.AggregationTypeDTO.get(clientRequest, id));
