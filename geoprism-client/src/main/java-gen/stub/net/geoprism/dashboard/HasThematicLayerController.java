...
public class HasThematicLayerController extends HasThematicLayerControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    net.geoprism.dashboard.HasThematicLayerQueryDTO query = net.geoprism.dashboard.HasThematicLayerDTO.childQuery(clientRequest, childId);
  ...
  {
    net.geoprism.dashboard.HasThematicLayerDTO dto = net.geoprism.dashboard.HasThematicLayerDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.HasThematicLayerDTO dto = new net.geoprism.dashboard.HasThematicLayerDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  public void newRelationship() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("childList", net.geoprism.dashboard.DashboardThematicLayerDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.HasThematicLayerQueryDTO query = net.geoprism.dashboard.HasThematicLayerDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.HasThematicLayerDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.HasThematicLayerQueryDTO query = net.geoprism.dashboard.HasThematicLayerDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.HasThematicLayerQueryDTO query = net.geoprism.dashboard.HasThematicLayerDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
