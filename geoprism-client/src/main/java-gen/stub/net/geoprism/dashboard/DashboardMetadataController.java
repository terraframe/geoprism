...
import net.geoprism.dashboard.DashboardMetadataControllerBase;
...
public class DashboardMetadataController extends DashboardMetadataControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    net.geoprism.dashboard.DashboardMetadataQueryDTO query = net.geoprism.dashboard.DashboardMetadataDTO.childQuery(clientRequest, childId);
  ...
  {
    net.geoprism.dashboard.DashboardMetadataDTO dto = net.geoprism.dashboard.DashboardMetadataDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.DashboardMetadataDTO dto = new net.geoprism.dashboard.DashboardMetadataDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.dashboard.DashboardMetadataQueryDTO query = net.geoprism.dashboard.DashboardMetadataDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.dashboard.DashboardMetadataDTO.get(clientRequest, id));
