...
import net.geoprism.ontology.ClassifierDisplayLabelControllerBase;
...
public class ClassifierDisplayLabelController extends ClassifierDisplayLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    net.geoprism.ontology.ClassifierDisplayLabelDTO dto = net.geoprism.ontology.ClassifierDisplayLabelDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.ontology.ClassifierDisplayLabelDTO.get(clientRequest, id));
