...
public class EmailSettingController extends EmailSettingControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    net.geoprism.EmailSettingDTO dto = net.geoprism.EmailSettingDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    net.geoprism.EmailSettingDTO dto = new net.geoprism.EmailSettingDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", net.geoprism.EmailSettingDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.EmailSettingQueryDTO query = net.geoprism.EmailSettingDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    net.geoprism.EmailSettingQueryDTO query = net.geoprism.EmailSettingDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
