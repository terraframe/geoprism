...
public class ClassifierDisplayLabelController extends ClassifierDisplayLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO dto = com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO dto = new com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelQueryDTO query = com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelQueryDTO query = com.runwaysdk.geodashboard.ontology.ClassifierDisplayLabelDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
