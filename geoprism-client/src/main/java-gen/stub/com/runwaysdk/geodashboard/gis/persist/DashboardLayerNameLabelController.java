...
public class DashboardLayerNameLabelController extends DashboardLayerNameLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO dto = com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO.get(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO dto = new com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelQueryDTO query = com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelQueryDTO query = com.runwaysdk.geodashboard.gis.persist.DashboardLayerNameLabelDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
