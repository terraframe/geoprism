...
public class LayerTypeController extends LayerTypeControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO dto = com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO dto = new com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.LayerTypeQueryDTO query = com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.LayerTypeQueryDTO query = com.runwaysdk.geodashboard.gis.persist.LayerTypeDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
