...
public abstract class UniversalAttributeBindingDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public net.geoprism.data.etl.TargetFieldGeoEntityBindingDTO getField()
  {
    ...
    {
      return net.geoprism.data.etl.TargetFieldGeoEntityBindingDTO.get(getRequest(), getValue(FIELD));
    }
  }
  ...
  public void setField(net.geoprism.data.etl.TargetFieldGeoEntityBindingDTO value)
  {
    if(value == null)
    {
      setValue(FIELD, "");
  ...
  {
    return (net.geoprism.data.etl.UniversalAttributeBindingQueryDTO) clientRequest.getAllInstances(net.geoprism.data.etl.UniversalAttributeBindingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
