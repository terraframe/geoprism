...
public abstract class LocalPersistenceStrategyDTOBase extends net.geoprism.data.etl.PersistenceStrategyDTO 
{
  ...
  */
  ...
  {
    return (net.geoprism.data.etl.LocalPersistenceStrategyQueryDTO) clientRequest.getAllInstances(net.geoprism.data.etl.LocalPersistenceStrategyDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
