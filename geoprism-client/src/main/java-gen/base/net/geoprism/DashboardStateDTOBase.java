...
public abstract class DashboardStateDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public static net.geoprism.DashboardStateDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (net.geoprism.DashboardStateDTO) dto;
  }
  ...
  public static net.geoprism.DashboardStateQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.DashboardStateQueryDTO) clientRequest.getAllInstances(net.geoprism.DashboardStateDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.DashboardStateDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.DashboardStateDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.DashboardStateDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.DashboardStateDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.DashboardStateDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.DashboardStateDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
