...
public java.util.List<? extends net.geoprism.report.PairViewDTO> getResultSet()
{
  return (java.util.List<? extends net.geoprism.report.PairViewDTO>)super.getResultSet();
}
}
