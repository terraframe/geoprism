...
public abstract class DHIS2ConfigurationDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  {
    return (net.geoprism.dhis2.DHIS2ConfigurationQueryDTO) clientRequest.getAllInstances(net.geoprism.dhis2.DHIS2ConfigurationDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
