...
public abstract class OptionCodeMappingDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  protected OptionCodeMappingDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected OptionCodeMappingDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  {
    return (net.geoprism.dhis2.OptionCodeMappingQueryDTO) clientRequest.getAllInstances(net.geoprism.dhis2.OptionCodeMappingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
