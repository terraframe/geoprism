...
public java.util.List<? extends net.geoprism.AttributeWrapperDTO> getResultSet()
{
  return (java.util.List<? extends net.geoprism.AttributeWrapperDTO>)super.getResultSet();
}
}
