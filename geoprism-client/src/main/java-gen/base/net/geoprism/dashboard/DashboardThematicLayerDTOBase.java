...
public abstract class DashboardThematicLayerDTOBase extends net.geoprism.dashboard.DashboardLayerDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public final java.lang.String applyWithStyleAndStrategy(net.geoprism.dashboard.DashboardStyleDTO style, java.lang.String mapId, net.geoprism.dashboard.AggregationStrategyDTO strategy, java.lang.String state)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "applyWithStyleAndStrategy", _declaredTypes);
    return (java.lang.String) getRequest().invokeMethod(_metadata, this, _parameters);
  }
  
  public static final java.lang.String applyWithStyleAndStrategy(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id, net.geoprism.dashboard.DashboardStyleDTO style, java.lang.String mapId, net.geoprism.dashboard.AggregationStrategyDTO strategy, java.lang.String state)
  {
  ...
  public final java.lang.String getFeatureInformation(java.lang.String featureId)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "getFeatureInformation", _declaredTypes);
    return (java.lang.String) getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static final java.lang.String getGeoNodeGeometryTypesJSON(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String geoNodeId)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "getGeoNodeGeometryTypesJSON", _declaredTypes);
    return (java.lang.String) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static final java.lang.String getOptionsJSON(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String thematicAttributeId, java.lang.String dashboardId)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "getOptionsJSON", _declaredTypes);
    return (java.lang.String) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static net.geoprism.dashboard.DashboardThematicLayerDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (net.geoprism.dashboard.DashboardThematicLayerDTO) dto;
  }
  ...
  public static net.geoprism.dashboard.DashboardThematicLayerQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.dashboard.DashboardThematicLayerQueryDTO) clientRequest.getAllInstances(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.dashboard.DashboardThematicLayerDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.dashboard.DashboardThematicLayerDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.dashboard.DashboardThematicLayerDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardThematicLayerDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.dashboard.DashboardThematicLayerDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
