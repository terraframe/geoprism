...
public java.util.List<? extends net.geoprism.dashboard.DashboardDescriptionDTO> getResultSet()
{
  return (java.util.List<? extends net.geoprism.dashboard.DashboardDescriptionDTO>)super.getResultSet();
}
}
