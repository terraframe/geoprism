...
public java.util.List<? extends net.geoprism.dashboard.GeometryAggregationStrategyDTO> getResultSet()
{
  return (java.util.List<? extends net.geoprism.dashboard.GeometryAggregationStrategyDTO>)super.getResultSet();
}
}
