...
public abstract class DashboardStateDTOBase extends com.runwaysdk.business.BusinessDTO 
{
  ...
  */
  ...
  {
    return (net.geoprism.dashboard.DashboardStateQueryDTO) clientRequest.getAllInstances(net.geoprism.dashboard.DashboardStateDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
