...
public abstract class AggregationTypeDTOBase extends com.runwaysdk.system.EnumerationMasterDTO 
{
  ...
  */
  ...
  {
    return (net.geoprism.dashboard.AggregationTypeQueryDTO) clientRequest.getAllInstances(net.geoprism.dashboard.AggregationTypeDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
