...
public abstract class DashboardLayerDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public java.util.List<net.geoprism.dashboard.AllLayerTypeDTO> getLayerType()
  {
    return (java.util.List<net.geoprism.dashboard.AllLayerTypeDTO>) com.runwaysdk.transport.conversion.ConversionFacade.convertEnumDTOsFromEnumNames(getRequest(), net.geoprism.dashboard.AllLayerTypeDTO.CLASS, getEnumNames(LAYERTYPE));
  }
  ...
  public void addLayerType(net.geoprism.dashboard.AllLayerTypeDTO enumDTO)
  {
    addEnumItem(LAYERTYPE, enumDTO.toString());
  }
  
  public void removeLayerType(net.geoprism.dashboard.AllLayerTypeDTO enumDTO)
  {
  ...
  public net.geoprism.dashboard.DashboardLayerNameLabelDTO getNameLabel()
  {
    return (net.geoprism.dashboard.DashboardLayerNameLabelDTO) this.getAttributeStructDTO(NAMELABEL).getStructDTO();
  }
  ...
  public final java.lang.String getJSON()
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardLayerDTO.CLASS, "getJSON", _declaredTypes);
    return (java.lang.String) getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static final com.runwaysdk.system.gis.geo.UniversalQueryDTO getSortedUniversals(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardLayerDTO.CLASS, "getSortedUniversals", _declaredTypes);
  ...
  public final void updateLegend(java.lang.Integer legendXPosition, java.lang.Integer legendYPosition, java.lang.Boolean groupedInLegend)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardLayerDTO.CLASS, "updateLegend", _declaredTypes);
  ...
  {
    return (java.util.List<? extends net.geoprism.dashboard.DashboardStyleDTO>) getRequest().getChildren(this.getId(), net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends net.geoprism.dashboard.DashboardStyleDTO> getAllHasStyle(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends net.geoprism.dashboard.DashboardStyleDTO>) clientRequestIF.getChildren(id, net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends net.geoprism.dashboard.HasStyleDTO> getAllHasStyleRelationships()
  {
    return (java.util.List<? extends net.geoprism.dashboard.HasStyleDTO>) getRequest().getChildRelationships(this.getId(), net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends net.geoprism.dashboard.HasStyleDTO> getAllHasStyleRelationships(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends net.geoprism.dashboard.HasStyleDTO>) clientRequestIF.getChildRelationships(id, net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  public net.geoprism.dashboard.HasStyleDTO addHasStyle(net.geoprism.dashboard.DashboardStyleDTO child)
  {
    return (net.geoprism.dashboard.HasStyleDTO) getRequest().addChild(this.getId(), child.getId(), net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  public static net.geoprism.dashboard.HasStyleDTO addHasStyle(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id, net.geoprism.dashboard.DashboardStyleDTO child)
  {
    return (net.geoprism.dashboard.HasStyleDTO) clientRequestIF.addChild(id, child.getId(), net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  ...
  {
    getRequest().deleteChildren(this.getId(), net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  public static void removeAllHasStyle(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    clientRequestIF.deleteChildren(id, net.geoprism.dashboard.HasStyleDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends net.geoprism.dashboard.DashboardMapDTO> getAllContainingMap()
  {
    return (java.util.List<? extends net.geoprism.dashboard.DashboardMapDTO>) getRequest().getParents(this.getId(), net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends net.geoprism.dashboard.DashboardMapDTO> getAllContainingMap(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends net.geoprism.dashboard.DashboardMapDTO>) clientRequestIF.getParents(id, net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public java.util.List<? extends net.geoprism.dashboard.HasLayerDTO> getAllContainingMapRelationships()
  {
    return (java.util.List<? extends net.geoprism.dashboard.HasLayerDTO>) getRequest().getParentRelationships(this.getId(), net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends net.geoprism.dashboard.HasLayerDTO> getAllContainingMapRelationships(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    return (java.util.List<? extends net.geoprism.dashboard.HasLayerDTO>) clientRequestIF.getParentRelationships(id, net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  public net.geoprism.dashboard.HasLayerDTO addContainingMap(net.geoprism.dashboard.DashboardMapDTO parent)
  {
    return (net.geoprism.dashboard.HasLayerDTO) getRequest().addParent(parent.getId(), this.getId(), net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  public static net.geoprism.dashboard.HasLayerDTO addContainingMap(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id, net.geoprism.dashboard.DashboardMapDTO parent)
  {
    return (net.geoprism.dashboard.HasLayerDTO) clientRequestIF.addParent(parent.getId(), id, net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  public void removeContainingMap(net.geoprism.dashboard.HasLayerDTO relationship)
  {
    getRequest().deleteParent(relationship.getId());
  }
  
  public static void removeContainingMap(com.runwaysdk.constants.ClientRequestIF clientRequestIF, net.geoprism.dashboard.HasLayerDTO relationship)
  {
  ...
  {
    getRequest().deleteParents(this.getId(), net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  public static void removeAllContainingMap(com.runwaysdk.constants.ClientRequestIF clientRequestIF, String id)
  {
    clientRequestIF.deleteParents(id, net.geoprism.dashboard.HasLayerDTO.CLASS);
  }
  
  public static net.geoprism.dashboard.DashboardLayerDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (net.geoprism.dashboard.DashboardLayerDTO) dto;
  }
  ...
  public static net.geoprism.dashboard.DashboardLayerQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.dashboard.DashboardLayerQueryDTO) clientRequest.getAllInstances(net.geoprism.dashboard.DashboardLayerDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.dashboard.DashboardLayerDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardLayerDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.dashboard.DashboardLayerDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.dashboard.DashboardLayerDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.dashboard.DashboardLayerDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.dashboard.DashboardLayerDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
