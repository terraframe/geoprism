...
public abstract class LayerTypeDTOBase extends com.runwaysdk.system.EnumerationMasterDTO 
{
  ...
  */
  ...
  {
    return (net.geoprism.dashboard.layer.LayerTypeQueryDTO) clientRequest.getAllInstances(net.geoprism.dashboard.layer.LayerTypeDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
