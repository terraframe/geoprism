...
public java.util.List<? extends net.geoprism.dashboard.layer.DashboardReferenceLayerViewDTO> getResultSet()
{
  return (java.util.List<? extends net.geoprism.dashboard.layer.DashboardReferenceLayerViewDTO>)super.getResultSet();
}
}
