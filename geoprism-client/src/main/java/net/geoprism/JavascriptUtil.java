...
import net.geoprism.DashboardController;
...
import net.geoprism.dashboard.DashboardLayerController;
import net.geoprism.dashboard.DashboardLayerDTO;
import net.geoprism.dashboard.DashboardLayerViewDTO;
import net.geoprism.dashboard.DashboardMapController;
import net.geoprism.dashboard.DashboardMapDTO;
import net.geoprism.dashboard.DashboardReferenceLayerController;
import net.geoprism.dashboard.DashboardReferenceLayerDTO;
import net.geoprism.dashboard.DashboardReferenceLayerViewDTO;
import net.geoprism.dashboard.DashboardStyleDTO;
import net.geoprism.dashboard.DashboardThematicLayerController;
import net.geoprism.dashboard.DashboardThematicLayerDTO;
