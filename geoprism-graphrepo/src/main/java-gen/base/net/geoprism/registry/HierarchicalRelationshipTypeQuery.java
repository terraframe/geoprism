...
@com.runwaysdk.business.ClassSignature(hash = -1966577058)
/**
...

{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.HierarchicalRelationshipType.ORIGIN, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOrigin(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.registry.HierarchicalRelationshipType.ORIGIN, alias, displayLabel);
 ...
 **/
 ...
 implements HierarchicalRelationshipTypeQueryReferenceIF
  ...
  public com.runwaysdk.query.SelectableChar getOrigin(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.HierarchicalRelationshipType.ORIGIN, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOrigin(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.registry.HierarchicalRelationshipType.ORIGIN, alias, displayLabel);
