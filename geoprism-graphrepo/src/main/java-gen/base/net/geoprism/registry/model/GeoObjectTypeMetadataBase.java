...
@com.runwaysdk.business.ClassSignature(hash = 404809876)
/**
 ...
 */
public abstract class GeoObjectTypeMetadataBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = 404809876;
  
  public GeoObjectTypeMetadataBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.model.GeoObjectTypeMetadata.CLASS);
  ...
  public static GeoObjectTypeMetadataQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    GeoObjectTypeMetadataQuery query = new GeoObjectTypeMetadataQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static GeoObjectTypeMetadata get(String oid)
  {
    return (GeoObjectTypeMetadata) com.runwaysdk.business.Business.get(oid);
  }
  
  public static GeoObjectTypeMetadata getByKey(String key)
  {
    return (GeoObjectTypeMetadata) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static GeoObjectTypeMetadata lock(java.lang.String oid)
  {
    GeoObjectTypeMetadata _instance = GeoObjectTypeMetadata.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static GeoObjectTypeMetadata unlock(java.lang.String oid)
  {
    GeoObjectTypeMetadata _instance = GeoObjectTypeMetadata.get(oid);
    _instance.unlock();
