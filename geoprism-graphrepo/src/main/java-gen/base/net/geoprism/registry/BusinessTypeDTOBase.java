...
@com.runwaysdk.business.ClassSignature(hash = -111800259)
public abstract class BusinessTypeDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = -111800259;
  ...
  */
  protected BusinessTypeDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public net.geoprism.registry.BusinessTypeDisplayLabelDTO getDisplayLabel()
  {
    return (net.geoprism.registry.BusinessTypeDisplayLabelDTO) this.getAttributeStructDTO(DISPLAYLABEL).getStructDTO();
  }
  ...
  public static net.geoprism.registry.BusinessTypeDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (net.geoprism.registry.BusinessTypeDTO) dto;
  }
  ...
  public static net.geoprism.registry.BusinessTypeQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.registry.BusinessTypeQueryDTO) clientRequest.getAllInstances(net.geoprism.registry.BusinessTypeDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.registry.BusinessTypeDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.BusinessTypeDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.registry.BusinessTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.registry.BusinessTypeDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.BusinessTypeDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.registry.BusinessTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
