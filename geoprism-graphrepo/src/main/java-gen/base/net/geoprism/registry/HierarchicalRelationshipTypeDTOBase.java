...
@com.runwaysdk.business.ClassSignature(hash = 821909503)
public abstract class HierarchicalRelationshipTypeDTOBase extends com.runwaysdk.business.BusinessDTO
{
  public final static String CLASS = "net.geoprism.registry.HierarchicalRelationshipType";
  private static final long serialVersionUID = 821909503;
  
  protected HierarchicalRelationshipTypeDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected HierarchicalRelationshipTypeDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public net.geoprism.registry.HierarchicalRelationshipTypeDescriptionDTO getDescription()
  {
    return (net.geoprism.registry.HierarchicalRelationshipTypeDescriptionDTO) this.getAttributeStructDTO(DESCRIPTION).getStructDTO();
  }
  ...
  public net.geoprism.registry.HierarchicalRelationshipTypeDisplayLabelDTO getDisplayLabel()
  {
    return (net.geoprism.registry.HierarchicalRelationshipTypeDisplayLabelDTO) this.getAttributeStructDTO(DISPLAYLABEL).getStructDTO();
  }
  ...
  public static net.geoprism.registry.HierarchicalRelationshipTypeDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (net.geoprism.registry.HierarchicalRelationshipTypeDTO) dto;
  }
  ...
  public static net.geoprism.registry.HierarchicalRelationshipTypeQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.registry.HierarchicalRelationshipTypeQueryDTO) clientRequest.getAllInstances(net.geoprism.registry.HierarchicalRelationshipTypeDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.registry.HierarchicalRelationshipTypeDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.HierarchicalRelationshipTypeDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.registry.HierarchicalRelationshipTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.registry.HierarchicalRelationshipTypeDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.HierarchicalRelationshipTypeDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.registry.HierarchicalRelationshipTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
