...
@com.runwaysdk.business.ClassSignature(hash = -1208681788)
/**
...
public abstract class DirectedAcyclicGraphTypeBase extends net.geoprism.registry.graph.EdgeClass
{
  ...
  private static final long serialVersionUID = -1208681788;
  ...
  {
    return (DirectedAcyclicGraphType) com.runwaysdk.business.graph.VertexObject.get(CLASS, oid);
  }
