...
@com.runwaysdk.business.ClassSignature(hash = -916241164)
/**
 ...
 */
public abstract class DirectedAcyclicGraphTypeBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -916241164;
  ...
  public net.geoprism.registry.DirectedAcyclicGraphTypeDescription getDescription()
  {
    return (net.geoprism.registry.DirectedAcyclicGraphTypeDescription) description;
  }
  ...
  public net.geoprism.registry.DirectedAcyclicGraphTypeDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.registry.DirectedAcyclicGraphTypeDisplayLabel) displayLabel;
  }
  ...
  public static DirectedAcyclicGraphTypeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    DirectedAcyclicGraphTypeQuery query = new DirectedAcyclicGraphTypeQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static DirectedAcyclicGraphType get(String oid)
  {
    return (DirectedAcyclicGraphType) com.runwaysdk.business.Business.get(oid);
  }
  
  public static DirectedAcyclicGraphType getByKey(String key)
  {
    return (DirectedAcyclicGraphType) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static DirectedAcyclicGraphType lock(java.lang.String oid)
  {
    DirectedAcyclicGraphType _instance = DirectedAcyclicGraphType.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static DirectedAcyclicGraphType unlock(java.lang.String oid)
  {
    DirectedAcyclicGraphType _instance = DirectedAcyclicGraphType.get(oid);
    _instance.unlock();
