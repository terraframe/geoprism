...
@com.runwaysdk.business.ClassSignature(hash = -975082781)
public abstract class UndirectedGraphTypeDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = -975082781;
  ...
  */
  protected UndirectedGraphTypeDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public net.geoprism.registry.UndirectedGraphTypeDescriptionDTO getDescription()
  {
    return (net.geoprism.registry.UndirectedGraphTypeDescriptionDTO) this.getAttributeStructDTO(DESCRIPTION).getStructDTO();
  }
  ...
  public net.geoprism.registry.UndirectedGraphTypeDisplayLabelDTO getDisplayLabel()
  {
    return (net.geoprism.registry.UndirectedGraphTypeDisplayLabelDTO) this.getAttributeStructDTO(DISPLAYLABEL).getStructDTO();
  }
  ...
  public static net.geoprism.registry.UndirectedGraphTypeDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (net.geoprism.registry.UndirectedGraphTypeDTO) dto;
  }
  ...
  public static net.geoprism.registry.UndirectedGraphTypeQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.registry.UndirectedGraphTypeQueryDTO) clientRequest.getAllInstances(net.geoprism.registry.UndirectedGraphTypeDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.registry.UndirectedGraphTypeDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.UndirectedGraphTypeDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.registry.UndirectedGraphTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.registry.UndirectedGraphTypeDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.UndirectedGraphTypeDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.registry.UndirectedGraphTypeDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
