...
@com.runwaysdk.business.ClassSignature(hash = -125104885)
/**
 ...
 */
public abstract class UndirectedGraphTypeBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -125104885;
  ...
  public net.geoprism.registry.UndirectedGraphTypeDescription getDescription()
  {
    return (net.geoprism.registry.UndirectedGraphTypeDescription) description;
  }
  ...
  public net.geoprism.registry.UndirectedGraphTypeDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.registry.UndirectedGraphTypeDisplayLabel) displayLabel;
  }
  ...
  public static UndirectedGraphTypeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    UndirectedGraphTypeQuery query = new UndirectedGraphTypeQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (UndirectedGraphType) com.runwaysdk.business.Business.get(oid);
  }
  
  public static UndirectedGraphType getByKey(String key)
  {
    return (UndirectedGraphType) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static UndirectedGraphType lock(java.lang.String oid)
  {
    UndirectedGraphType _instance = UndirectedGraphType.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static UndirectedGraphType unlock(java.lang.String oid)
  {
    UndirectedGraphType _instance = UndirectedGraphType.get(oid);
    _instance.unlock();
