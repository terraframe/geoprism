 ...
 * BE OVERWRITTEN Custom business logic should be added to AttributeType.java
 *
 * @author Autogenerated by RunwaySDK
 */
public abstract class AttributeTypeBase extends SchemaElement
{
  ...
  public final static java.lang.String ISVIRTUAL        = "isVirtual";
  ...
  {
    return (Boolean) this.getObjectValue(ISVIRTUAL);
  }

  public static com.runwaysdk.dataaccess.MdAttributeBooleanDAOIF getIsVirtualMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.graph.AttributeType.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeBooleanDAOIF) mdClassIF.definesAttribute(ISVIRTUAL);
  }

  public void setIsVirtual(Boolean value)
  {
    this.setValue(ISVIRTUAL, value);
  }
