...
public class ServerChildGraphNode extends ServerGraphNode
{
  ...
  public ServerChildGraphNode(ServerGeoObjectIF geoObject, GraphType graphType, Date startDate, Date endDate, String oid, String uid, DataSource source)
  {
  ...
  public static ServerChildGraphNode fromJSON(JsonObject jo)
  {
    ...
    ServerChildGraphNode node = new ServerChildGraphNode(goif, graphType, startDate, endDate, oid, uid, source);
