...
{
  Optional<ConceptObject> getByCode(String code);
  ...
  NodeDTO<ObjectAtTimeDTO> getAncestorTree(AttributeClassificationType attribute, ConceptObject object, Integer pageSize);
