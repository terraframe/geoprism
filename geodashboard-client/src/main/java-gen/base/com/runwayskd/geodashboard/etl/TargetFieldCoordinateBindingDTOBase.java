...
public abstract class TargetFieldCoordinateBindingDTOBase extends com.runwayskd.geodashboard.etl.TargetFieldBasicBindingDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public static com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO) dto;
  }
  ...
  public static com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingQueryDTO) clientRequest.getAllInstances(com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO.CLASS, "lock", _declaredTypes);
    return (com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO.CLASS, "unlock", _declaredTypes);
    return (com.runwayskd.geodashboard.etl.TargetFieldCoordinateBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
