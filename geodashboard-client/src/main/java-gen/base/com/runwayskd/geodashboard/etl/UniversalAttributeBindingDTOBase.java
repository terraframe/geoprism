...
public abstract class UniversalAttributeBindingDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  protected UniversalAttributeBindingDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public com.runwayskd.geodashboard.etl.TargetFieldGeoEntityBindingDTO getField()
  {
    if(getValue(FIELD) == null || getValue(FIELD).trim().equals(""))
    {
      return null;
    }
    else
    {
      return com.runwayskd.geodashboard.etl.TargetFieldGeoEntityBindingDTO.get(getRequest(), getValue(FIELD));
    }
  }
  ...
  public void setField(com.runwayskd.geodashboard.etl.TargetFieldGeoEntityBindingDTO value)
  {
    if(value == null)
    {
      setValue(FIELD, "");
  ...
  public final com.runwaysdk.transport.metadata.AttributeReferenceMdDTO getFieldMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(FIELD).getAttributeMdDTO();
  }
  ...
  public static com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO) dto;
  }
  ...
  public static com.runwayskd.geodashboard.etl.UniversalAttributeBindingQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (com.runwayskd.geodashboard.etl.UniversalAttributeBindingQueryDTO) clientRequest.getAllInstances(com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO.CLASS, "lock", _declaredTypes);
    return (com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO.CLASS, "unlock", _declaredTypes);
    return (com.runwayskd.geodashboard.etl.UniversalAttributeBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
