...
@com.runwaysdk.business.ClassSignature(hash = 866217010)
public abstract class ReportItemDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 866217010;
  ...
  */
  ...
  public com.runwaysdk.geodashboard.report.ReportItemReportLabelDTO getReportLabel()
  {
    return (com.runwaysdk.geodashboard.report.ReportItemReportLabelDTO) this.getAttributeStructDTO(REPORTLABEL).getStructDTO();
  }
  ...
  public final void applyWithFile(java.io.InputStream fileStream)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "applyWithFile", _declaredTypes);
  ...
  public final java.io.InputStream getDesignAsStream()
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "getDesignAsStream", _declaredTypes);
  ...
  public final java.io.InputStream getDocumentAsStream()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "getDocumentAsStream", _declaredTypes);
    return (java.io.InputStream) getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static final com.runwaysdk.business.ValueQueryDTO getMetadataForReporting(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String queryId, java.lang.String category, java.lang.String criteria)
  {
    String[] _declaredTypes = new String[]{"java.lang.String", "java.lang.String", "java.lang.String"};
    Object[] _parameters = new Object[]{queryId, category, criteria};
  ...
  public static final com.runwaysdk.geodashboard.report.PairViewDTO[] getQueriesForReporting(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "getQueriesForReporting", _declaredTypes);
    return (com.runwaysdk.geodashboard.report.PairViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final com.runwaysdk.geodashboard.report.ReportItemDTO getReportItemForDashboard(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String dashboardId)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{dashboardId};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "getReportItemForDashboard", _declaredTypes);
    return (com.runwaysdk.geodashboard.report.ReportItemDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final com.runwaysdk.geodashboard.report.PairViewDTO[] getSupportedAggregation(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String queryId)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
  ...
  public final java.lang.String getURL()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "getURL", _declaredTypes);
    return (java.lang.String) getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static final com.runwaysdk.business.ValueQueryDTO getValuesForReporting(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String queryId, java.lang.String category, java.lang.String criteria, java.lang.String aggregation)
  {
  ...
  public final void validatePermissions()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "validatePermissions", _declaredTypes);
    getRequest().invokeMethod(_metadata, this, _parameters);
  }
  ...
  public static com.runwaysdk.geodashboard.report.ReportItemDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (com.runwaysdk.geodashboard.report.ReportItemDTO) dto;
  }
  ...
  public static com.runwaysdk.geodashboard.report.ReportItemQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (com.runwaysdk.geodashboard.report.ReportItemQueryDTO) clientRequest.getAllInstances(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static com.runwaysdk.geodashboard.report.ReportItemDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "lock", _declaredTypes);
    return (com.runwaysdk.geodashboard.report.ReportItemDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static com.runwaysdk.geodashboard.report.ReportItemDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(com.runwaysdk.geodashboard.report.ReportItemDTO.CLASS, "unlock", _declaredTypes);
    return (com.runwaysdk.geodashboard.report.ReportItemDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
