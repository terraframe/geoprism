...
public class ClassifierSynonymController extends ClassifierSynonymControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO dto = com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO dto = new com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.ontology.ClassifierSynonymQueryDTO query = com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.ontology.ClassifierSynonymQueryDTO query = com.runwaysdk.geodashboard.ontology.ClassifierSynonymDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
