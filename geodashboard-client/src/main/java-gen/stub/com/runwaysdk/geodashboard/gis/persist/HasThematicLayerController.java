...
public class HasThematicLayerController extends HasThematicLayerControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerQueryDTO query = com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.childQuery(clientRequest, childId);
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO dto = com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO dto = new com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  public void newRelationship() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("childList", com.runwaysdk.geodashboard.gis.persist.DashboardThematicLayerDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerQueryDTO query = com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerQueryDTO query = com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.HasThematicLayerQueryDTO query = com.runwaysdk.geodashboard.gis.persist.HasThematicLayerDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
