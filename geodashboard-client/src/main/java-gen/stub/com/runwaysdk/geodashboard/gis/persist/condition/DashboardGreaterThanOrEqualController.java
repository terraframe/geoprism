...
public class DashboardGreaterThanOrEqualController extends DashboardGreaterThanOrEqualControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/geodashboard/gis/persist/condition/DashboardGreaterThanOrEqual/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public DashboardGreaterThanOrEqualController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO dto = com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO.lock(super.getClientRequest(), id);
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO dto = new com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO(clientRequest);
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardGreaterThanOrEqualDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
