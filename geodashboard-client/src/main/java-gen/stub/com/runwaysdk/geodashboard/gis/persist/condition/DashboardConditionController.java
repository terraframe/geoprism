...
public class DashboardConditionController extends DashboardConditionControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/geodashboard/gis/persist/condition/DashboardCondition/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public DashboardConditionController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO dto = com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.lock(super.getClientRequest(), id);
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
