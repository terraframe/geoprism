...
public class DashboardOrController extends DashboardOrControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "/WEB-INF/com/runwaysdk/geodashboard/gis/persist/condition/DashboardOr/";
  public static final String LAYOUT = "WEB-INF/templates/layout.jsp";
  
  public DashboardOrController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO dto = com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO.lock(super.getClientRequest(), id);
    req.setAttribute("_leftCondition", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("_rightCondition", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO dto = new com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO(clientRequest);
    req.setAttribute("_leftCondition", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("_rightCondition", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("_rightCondition", com.runwaysdk.geodashboard.gis.persist.condition.DashboardConditionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("_styleReference", com.runwaysdk.geodashboard.gis.persist.DashboardStyleDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO.get(clientRequest, id));
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrQueryDTO query = com.runwaysdk.geodashboard.gis.persist.condition.DashboardOrDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
