 ...
 */
public abstract class SecondaryAttributeStyleBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    this.validateAttribute(CATEGORIES);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeTextDAOIF getCategoriesMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(com.runwaysdk.geodashboard.gis.persist.SecondaryAttributeStyle.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeTextDAOIF)mdClassIF.definesAttribute(CATEGORIES);
  }
  ...
  public static SecondaryAttributeStyleQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SecondaryAttributeStyleQuery query = new SecondaryAttributeStyleQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static SecondaryAttributeStyle get(String id)
  {
    return (SecondaryAttributeStyle) com.runwaysdk.business.Business.get(id);
  }
  
  public static SecondaryAttributeStyle getByKey(String key)
  {
  ...
  public static SecondaryAttributeStyle lock(java.lang.String id)
  {
    SecondaryAttributeStyle _instance = SecondaryAttributeStyle.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static SecondaryAttributeStyle unlock(java.lang.String id)
  {
    SecondaryAttributeStyle _instance = SecondaryAttributeStyle.get(id);
    _instance.unlock();
