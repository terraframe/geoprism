 ...
 
{
  ...
  {
    return (com.runwaysdk.query.SelectableUUID)this.getSelectable(net.geoprism.ontology.ClassifierProblemView.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableUUID getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableUUID)this.getSelectable(net.geoprism.ontology.ClassifierProblemView.OID, alias, displayLabel);
