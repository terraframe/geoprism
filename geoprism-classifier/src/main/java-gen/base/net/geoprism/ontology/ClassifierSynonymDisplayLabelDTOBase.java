...
public abstract class ClassifierSynonymDisplayLabelDTOBase extends com.runwaysdk.business.LocalStructDTO 
{
  ...
  */
  ...
  {
    return (net.geoprism.ontology.ClassifierSynonymDisplayLabelQueryDTO) clientRequest.getAllInstances(net.geoprism.ontology.ClassifierSynonymDisplayLabelDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
