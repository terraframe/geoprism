...
public abstract class AttributeStructType extends AttributeType
{
  /**
   * 
   */
  ...
  public AttributeStructType(String _name, LocalizedValue _label, LocalizedValue _description, String _type, boolean _isDefault, boolean _required, boolean _unique, boolean isChangeOverTime)
  {
