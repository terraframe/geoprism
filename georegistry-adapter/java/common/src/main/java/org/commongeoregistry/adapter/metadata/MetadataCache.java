...
/**
 * This is a singleton instance that caches {@link GeoObjectType} objects for
 * creating {@link GeoObject}s and that caches {@link HierarchyType}.
 * 
 * @author nathan
 *
 */
public class MetadataCache implements Serializable, MetadataCacheIF
{
  /**
   * 
   */
  ...
  public List<OrganizationDTO> getAllOrganizations()
  {
    ...
    // OrganizationDTO[this.organizationMap.values().size()]);
  ...
  {
    // return this.hierarchyTypeMap.values().toArray(new
    // HierarchyType[this.hierarchyTypeMap.values().size()]);
