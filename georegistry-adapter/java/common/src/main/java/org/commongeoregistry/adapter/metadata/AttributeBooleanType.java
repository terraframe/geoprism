...
public class AttributeBooleanType extends AttributeType
{
  ...
  public AttributeBooleanType(String _name, LocalizedValue _label, LocalizedValue _description, boolean _isDefault, boolean _required, boolean _unique, boolean isChangeOverTime)
  {
