...
@JsonTypeName(AttributeGeometryType.TYPE)
public class AttributeGeometryType extends AttributeType
{
  ...
  public AttributeGeometryType(String _name, LocalizedValue _label, LocalizedValue _description, boolean _isDefault, boolean _required, boolean _unique, boolean isChangeOverTime)
  {
