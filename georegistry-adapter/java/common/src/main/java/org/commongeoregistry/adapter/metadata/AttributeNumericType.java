...
public abstract class AttributeNumericType extends AttributePrimitiveType
{
  ...
  public AttributeNumericType(String _name, LocalizedValue _label, LocalizedValue _description, String _type, boolean _isDefault, boolean _required, boolean _unique, boolean isChangeOverTime)
  {
    super(_name, _label, _description, _type, _isDefault, _required, _unique, isChangeOverTime);
  }
}
