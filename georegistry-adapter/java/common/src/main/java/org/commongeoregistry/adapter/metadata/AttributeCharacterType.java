...
@JsonTypeName(AttributeCharacterType.TYPE)
public class AttributeCharacterType extends AttributePrimitiveType
{
  ...
  public AttributeCharacterType(String _name, LocalizedValue _label, LocalizedValue _description, boolean _isDefault, boolean _required, boolean _unique, boolean isChangeOverTime)
  {
