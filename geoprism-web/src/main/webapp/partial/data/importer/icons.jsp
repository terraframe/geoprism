...
<div id="app-container" class="container" >
  ...
  <div class="list-table-wrapper">
	...
	<!--      REMOVED:  onerror="if (this.src != 'net/geoprism/images/dashboard_icon_small.png') this.src = 'net/geoprism/images/dashboard_icon_small.png';" -->
	          <img ng-if="icon.id && icon.id.length > 0" style="width:42px;height:42px;" class="thumb" ng-src="${pageContext.request.contextPath}/iconimage/getCategoryIconImage?iconId={{ icon.id }}&{{ icon.timeStamp }}" alt="Icon">                  
	        </td>
	      </tr>      
        <tr>
          <td class="button-column">
		            ...
		            <div class="holder">
		              <span class="text">
		                ...
		                <div ng-show="icon.file">
		                  ...
		                  <img ng-if="icon.id && icon.id.length > 0 && editIcon && icon.file.filePath" style="width:42px;height:42px;margin-left:10px;" ng-src="${pageContext.request.contextPath}/iconimage/getCategoryIconImage?iconId={{ editIcon }}&''" class="thumb">
