...
(function(){
  ...
  var schedulerName = 'net.geoprism.account.scheduler.Scheduler';
  var jobTableName = 'net.geoprism.account.scheduler.JobTable';
  var jobHistoryTableName = "net.geoprism.account.scheduler.JobHistoryTable";
  ...
  var JobTable = ClassFramework.newClass(jobTableName, {
    ...
    Instance : {
      ...
      _openEditMenu : function(row, job) {
        ...
        {
          var descriptionInput = net.geoprism.FormEntry.newInput('textarea', 'description', {attributes:{type:'text', id:'description'}});
        ...
        else if(job.isDescriptionReadable())
        {
          ...
          var entry = new net.geoprism.ReadEntry('description', label, job ? job.getLocalizedValue() : "");
          form.addEntry(label, entry);                  
        }
        
        if(job.isCronExpressionWritable())
        {
          var entry = new net.geoprism.CronEntry("cron");
        ...
        var ds = new InstanceQueryDataSource({
          ...
          columns: [
            ...
            { header: this.localize("scheduledRun"), customFormatter: function(job) {
                return net.geoprism.CronUtil.cronToHumanReadable(job.getCronExpression());
              }
            }
          ]
        });
