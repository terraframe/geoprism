...
<mjl:table var="item" query="${query}">
  <mjl:context action="net.geoprism.ontologylExportMenuController.viewPage.mojo" />
  <mjl:columns>
...
<br />
<mjl:commandLink name="UniversalExportMenuController.newInstance" action="net.geoprism.ontolnet.geoprism.ontologyler.newInstance.mojo">
