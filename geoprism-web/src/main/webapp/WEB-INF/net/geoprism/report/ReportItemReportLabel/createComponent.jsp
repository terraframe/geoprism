...
<dl>
  <mjl:form id="net.geoprism.report.ReportItemReportLabel.form.id" name="net.geoprism.report.ReportItemReportLabel.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.report.ReportItemReportLabel.form.create.button" value="Create" action="net.geoprism.report.ReportItemReportLabelController.create.mojo" />
  </mjl:form>
</dl>
