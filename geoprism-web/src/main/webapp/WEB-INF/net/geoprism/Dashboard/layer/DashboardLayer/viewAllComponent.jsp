...
<mjl:table var="item" query="${query}">
  <mjl:context action="net.geoprism.dashboard.DashboardLayerController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="net.geoprism.dashboard.DashboardLayerController.view.mojo">
          View
...
<br />
<mjl:commandLink name="DashboardLayerController.newInstance" action="net.geoprism.dashboard.DashboardLayerController.newInstance.mojo">
  Create a new Layer
</mjl:commandLink>
