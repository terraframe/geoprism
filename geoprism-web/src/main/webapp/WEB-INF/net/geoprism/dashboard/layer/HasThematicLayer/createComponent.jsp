...
<dl>
  <mjl:form id="net.geoprism.dashboard.layer.HasThematicLayer.form.id" name="net.geoprism.dashboard.layer.HasThematicLayer.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.layer.HasThematicLayer.form.create.button" value="Create" action="net.geoprism.dashboard.layer.HasThematicLayerController.create.mojo" />
  </mjl:form>
</dl>
