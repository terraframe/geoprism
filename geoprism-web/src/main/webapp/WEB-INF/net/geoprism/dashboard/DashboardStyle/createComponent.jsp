...
<dl>
  <mjl:form id="net.geoprism.dashboard.DashboardStyle.form.id" name="net.geoprism.dashboard.DashboardStyle.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardStyle.form.create.button" value="Create" action="net.geoprism.dashboard.DashboardStyleController.create.mojo" />
  </mjl:form>
</dl>
