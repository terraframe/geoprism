...
<dl>
  <mjl:form method="POST" name="net.geoprism.dashboard.DashboardThematicStyle.form.name" id="net.geoprism.dashboard.DashboardThematicStyle.form.id">
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardThematicStyle.form.create.button" action="net.geoprism.dashboard.DashboardThematicStyleController.create.mojo" value="Create" />
  </mjl:form>
</dl>
