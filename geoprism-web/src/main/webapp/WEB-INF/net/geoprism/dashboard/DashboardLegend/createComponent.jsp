...
<dl>
  <mjl:form id="net.geoprism.dashboard.DashboardLegend.form.id" name="net.geoprism.dashboard.DashboardLegend.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardLegend.form.create.button" value="Create" action="net.geoprism.dashboard.DashboardLegendController.create.mojo" />
  </mjl:form>
</dl>
