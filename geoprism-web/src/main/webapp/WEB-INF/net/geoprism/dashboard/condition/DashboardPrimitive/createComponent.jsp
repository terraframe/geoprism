...
<dl>
  <mjl:form id="net.geoprism.dashboard.condition.DashboardPrimitive.form.id" name="net.geoprism.dashboard.condition.DashboardPrimitive.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.condition.DashboardPrimitive.form.create.button" value="Create" action="net.geoprism.dashboard.condition.DashboardPrimitiveController.create.mojo" />
  </mjl:form>
</dl>
