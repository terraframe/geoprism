...
<dl>
  <mjl:form id="net.geoprism.dashboard.condition.DashboardNotEqual.form.id" name="net.geoprism.dashboard.condition.DashboardNotEqual.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.condition.DashboardNotEqual.form.create.button" value="Create" action="net.geoprism.dashboard.condition.DashboardNotEqualController.create.mojo" />
  </mjl:form>
</dl>
