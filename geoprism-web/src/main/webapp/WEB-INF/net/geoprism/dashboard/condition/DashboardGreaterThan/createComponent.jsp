...
<dl>
  <mjl:form id="net.geoprism.dashboard.condition.DashboardGreaterThan.form.id" name="net.geoprism.dashboard.condition.DashboardGreaterThan.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.condition.DashboardGreaterThan.form.create.button" value="Create" action="net.geoprism.dashboard.condition.DashboardGreaterThanController.create.mojo" />
  </mjl:form>
</dl>
