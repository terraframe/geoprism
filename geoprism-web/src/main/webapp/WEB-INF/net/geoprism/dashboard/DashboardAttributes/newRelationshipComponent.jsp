...
<mjl:form id="net.geoprism.dashboard.DashboardAttributes.form.id" name="net.geoprism.dashboard.DashboardAttributes.form.name" method="POST">
  <dl>
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardAttributes.form.newInstance.button" value="New Instance" action="net.geoprism.dashboard.DashboardAttributesController.newInstance.mojo" />
  </dl>
</mjl:form>
