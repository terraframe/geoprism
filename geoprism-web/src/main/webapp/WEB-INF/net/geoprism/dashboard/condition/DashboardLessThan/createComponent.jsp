...
<dl>
  <mjl:form id="net.geoprism.dashboard.condition.DashboardLessThan.form.id" name="net.geoprism.dashboard.condition.DashboardLessThan.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.condition.DashboardLessThan.form.create.button" value="Create" action="net.geoprism.dashboard.condition.DashboardLessThanController.create.mojo" />
  </mjl:form>
</dl>
