...
<dl>
  <mjl:form id="net.geoprism.dashboard.DashboardAttributes.form.id" name="net.geoprism.dashboard.DashboardAttributes.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardAttributes.form.create.button" value="Create" action="net.geoprism.dashboard.DashboardAttributesController.create.mojo" />
  </mjl:form>
</dl>
