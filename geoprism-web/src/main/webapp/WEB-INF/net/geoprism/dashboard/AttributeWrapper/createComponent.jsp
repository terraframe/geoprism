...
<dl>
  <mjl:form id="net.geoprism.dashboard.AttributeWrapper.form.id" name="net.geoprism.dashboard.AttributeWrapper.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.AttributeWrapper.form.create.button" value="Create" action="net.geoprism.dashboard.AttributeWrapperController.create.mojo" />
  </mjl:form>
</dl>
