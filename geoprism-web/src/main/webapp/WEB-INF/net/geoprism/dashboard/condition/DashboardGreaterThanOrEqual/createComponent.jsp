...
<dl>
  <mjl:form id="net.geoprism.dashboard.condition.DashboardGreaterThanOrEqual.form.id" name="net.geoprism.dashboard.condition.DashboardGreaterThanOrEqual.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.condition.DashboardGreaterThanOrEqual.form.create.button" value="Create" action="net.geoprism.dashboard.condition.DashboardGreaterThanOrEqualController.create.mojo" />
  </mjl:form>
</dl>
