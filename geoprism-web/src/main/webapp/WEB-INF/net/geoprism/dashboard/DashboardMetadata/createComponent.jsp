...
<dl>
  <mjl:form id="net.geoprism.dashboard.DashboardMetadata.form.id" name="net.geoprism.dashboard.DashboardMetadata.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardMetadata.form.create.button" value="Create" action="net.geoprism.dashboard.DashboardMetadataController.create.mojo" />
  </mjl:form>
</dl>
