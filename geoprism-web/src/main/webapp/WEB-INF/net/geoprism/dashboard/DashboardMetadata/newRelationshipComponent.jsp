...
<mjl:form id="net.geoprism.dashboard.DashboardMetadata.form.id" name="net.geoprism.dashboard.DashboardMetadata.form.name" method="POST">
  <dl>
    ...
    <mjl:command name="net.geoprism.dashboard.DashboardMetadata.form.newInstance.button" value="New Instance" action="net.geoprism.dashboard.DashboardMetadataController.newInstance.mojo" />
  </dl>
</mjl:form>
