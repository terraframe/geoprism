...
<dl>
  <mjl:form id="net.geoprism.dashboard.MetadataWrapper.form.id" name="net.geoprism.dashboard.MetadataWrapper.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.dashboard.MetadataWrapper.form.create.button" value="Create" action="net.geoprism.dashboard.MetadataWrapperController.create.mojo" />
  </mjl:form>
</dl>
