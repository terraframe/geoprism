...
<dl>
  <mjl:form id="net.geoprism.ontology.ClassifierDisplayLabel.form.id" name="net.geoprism.ontology.ClassifierDisplayLabel.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.ontology.ClassifierDisplayLabel.form.create.button" value="Create" action="net.geoprism.ontology.ClassifierDisplayLabelController.create.mojo" />
  </mjl:form>
</dl>
