...
<mjl:table var="item" query="${query}">
  <mjl:context action="net.geoprism.ontology.GeoEntityExportMenuController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:attributeColumn attributeName="includeGIS">
    </mjl:attributeColumn>
    <mjl:freeColumn>
      <mjl:header>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="net.geoprism.ontology.GeoEntityExportMenuController.view.mojo">
          View
