...
<dl>
  <mjl:form method="POST" name="net.geoprism.ontology.UniversalExportMenu.form.name" id="net.geoprism.ontology.UniversalExportMenu.form.id">
    ...
    <mjl:command name="net.geoprism.ontology.UniversalExportMenu.form.edit.button" action="net.geoprism.ontology.UniversalExportMenuController.edit.mojo" value="Edit" />
  </mjl:form>
</dl>
<mjl:commandLink name="net.geoprism.ontology.UniversalExportMenu.viewAll.link" action="net.geoprism.ontology.UniversalExportMenuController.viewAll.mojo">
  View All
</mjl:commandLink>
