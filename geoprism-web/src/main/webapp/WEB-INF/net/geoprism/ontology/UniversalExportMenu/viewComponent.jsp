...
<dl>
  <mjl:form id="net.geoprism.ontology.UniversalExportMenu.form.id" name="net.geoprism.ontology.UniversalExportMenu.form.name" method="POST">
    ...
    <mjl:command name="net.geoprism.ontology.UniversalExportMenu.form.edit.button" value="Edit" action="net.geoprism.ontology.UniversalExportMenuController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="net.geoprism.ontology.UniversalExportMenu.viewAll.link" action="net.geoprism.ontology.UniversalExportMenu.viewAll.mojo">
</mjl:commandLink>
