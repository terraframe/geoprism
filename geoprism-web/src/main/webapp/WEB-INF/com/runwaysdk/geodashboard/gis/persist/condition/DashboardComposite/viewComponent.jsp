...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.gis.persist.condition.DashboardComposite.form.id" name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardComposite.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardComposite.form.edit.button" value="Edit" action="com.runwaysdk.geodashboard.gis.persist.condition.DashboardCompositeController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.geodashboard.gis.persist.condition.DashboardComposite.viewAll.link" action="com.runwaysdk.geodashboard.gis.persist.condition.DashboardCompositeController.viewAll.mojo">
  View All
</mjl:commandLink>
