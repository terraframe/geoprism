...
<dl>
  <mjl:form id="com.runwaysdk.geodashboard.DashboardDisplayLabel.form.id" name="com.runwaysdk.geodashboard.DashboardDisplayLabel.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.geodashboard.DashboardDisplayLabel.form.create.button" value="Create" action="com.runwaysdk.geodashboard.DashboardDisplayLabelController.create.mojo" />
  </mjl:form>
</dl>
