...
@com.runwaysdk.business.ClassSignature(hash = -1858110476)
/**
 ...
 */
public abstract class ConceptEdgeTypeSnapshotBase extends net.geoprism.graph.RelationshipTypeSnapshot
{
  public final static String CLASS = "net.geoprism.graph.ConceptEdgeTypeSnapshot";
  ...
  private static final long serialVersionUID = -1858110476;
  
  public ConceptEdgeTypeSnapshotBase()
  {
    super();
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.graph.ConceptEdgeTypeSnapshot.CLASS);
  ...
  public net.geoprism.graph.ConceptEdgeTypeSnapshotDescription getDescription()
  {
    return (net.geoprism.graph.ConceptEdgeTypeSnapshotDescription) description;
  }
  ...
  public net.geoprism.graph.ConceptEdgeTypeSnapshotDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.graph.ConceptEdgeTypeSnapshotDisplayLabel) displayLabel;
  }
  ...
  public static ConceptEdgeTypeSnapshotQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ConceptEdgeTypeSnapshotQuery query = new ConceptEdgeTypeSnapshotQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public net.geoprism.graph.ConceptSetSnapshotHasEdge addSetSnapshot(net.geoprism.graph.ConceptSetSnapshot conceptSetSnapshot)
  {
    return (net.geoprism.graph.ConceptSetSnapshotHasEdge) addParent(conceptSetSnapshot, net.geoprism.graph.ConceptSetSnapshotHasEdge.CLASS);
  }
  
  public void removeSetSnapshot(net.geoprism.graph.ConceptSetSnapshot conceptSetSnapshot)
  {
    removeAllParents(conceptSetSnapshot, net.geoprism.graph.ConceptSetSnapshotHasEdge.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshot> getAllSetSnapshot()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshot>) getParents(net.geoprism.graph.ConceptSetSnapshotHasEdge.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshotHasEdge> getAllSetSnapshotRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshotHasEdge>) getParentRelationships(net.geoprism.graph.ConceptSetSnapshotHasEdge.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshotHasEdge> getSetSnapshotRel(net.geoprism.graph.ConceptSetSnapshot conceptSetSnapshot)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.graph.ConceptSetSnapshotHasEdge>) getRelationshipsWithParent(conceptSetSnapshot, net.geoprism.graph.ConceptSetSnapshotHasEdge.CLASS);
  }
  
  public static ConceptEdgeTypeSnapshot get(String oid)
  {
    return (ConceptEdgeTypeSnapshot) com.runwaysdk.business.Business.get(oid);
  }
  
  public static ConceptEdgeTypeSnapshot getByKey(String key)
  {
    return (ConceptEdgeTypeSnapshot) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ConceptEdgeTypeSnapshot lock(java.lang.String oid)
  {
    ConceptEdgeTypeSnapshot _instance = ConceptEdgeTypeSnapshot.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static ConceptEdgeTypeSnapshot unlock(java.lang.String oid)
  {
    ConceptEdgeTypeSnapshot _instance = ConceptEdgeTypeSnapshot.get(oid);
    _instance.unlock();
