...
{
  public final static String CLASS = "net.geoprism.graph.LabeledPropertyGraphTypeVersion";
  ...
  */
  protected LabeledPropertyGraphTypeVersionDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public net.geoprism.graph.LabeledPropertyGraphTypeEntryDTO getEntry()
  {
    ...
    {
      return net.geoprism.graph.LabeledPropertyGraphTypeEntryDTO.get(getRequest(), getValue(ENTRY));
    }
  }
  ...
  public void setEntry(net.geoprism.graph.LabeledPropertyGraphTypeEntryDTO value)
  {
    if(value == null)
    {
      setValue(ENTRY, "");
  ...
  public final java.lang.String publish()
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO.CLASS, "publish", _declaredTypes);
  ...
  public final void remove()
  {
    String[] _declaredTypes = new String[]{};
    Object[] _parameters = new Object[]{};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO.CLASS, "remove", _declaredTypes);
  ...
  public static net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO) dto;
  }
  ...
  public static net.geoprism.graph.LabeledPropertyGraphTypeVersionQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.graph.LabeledPropertyGraphTypeVersionQueryDTO) clientRequest.getAllInstances(net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.graph.LabeledPropertyGraphTypeVersionDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
