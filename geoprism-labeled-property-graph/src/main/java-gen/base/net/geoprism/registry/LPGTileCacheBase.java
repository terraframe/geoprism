...
@com.runwaysdk.business.ClassSignature(hash = 727029969)
/**
 ...
 */
public abstract class LPGTileCacheBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = 727029969;
  
  public LPGTileCacheBase()
  {
    super();
  }
  ...
  public static LPGTileCacheQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    LPGTileCacheQuery query = new LPGTileCacheQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static LPGTileCache get(String oid)
  {
    return (LPGTileCache) com.runwaysdk.business.Business.get(oid);
  }
  
  public static LPGTileCache getByKey(String key)
  {
    return (LPGTileCache) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static LPGTileCache lock(java.lang.String oid)
  {
    LPGTileCache _instance = LPGTileCache.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static LPGTileCache unlock(java.lang.String oid)
  {
    LPGTileCache _instance = LPGTileCache.get(oid);
    _instance.unlock();
