...
public interface LabeledPropertyGraphTypeVersionBusinessServiceIF
{
  ...
  List<ConceptEdgeTypeSnapshot> getConceptEdgeTypes(LabeledPropertyGraphTypeVersion version);

  List<ConceptSetSnapshot> getConceptSets(LabeledPropertyGraphTypeVersion version);
