...
import net.geoprism.graph.lpg.adapter.exception.IncompatibleServerVersionException;
import net.geoprism.graph.lpg.adapter.exception.UnexpectedResponseException;
...
public class RegistryBridge
{
  ...
  {
    return this.apiGet(API_PATH + "/get", new BasicNameValuePair("oid", oid));
  }

  public RegistryResponse getEntry(String oid) throws HTTPException, BadServerUriException
  {
    return this.apiGet(API_PATH + "/entry", new BasicNameValuePair("oid", oid));
  }
  
  public RegistryResponse getEntries(String oid) throws HTTPException, BadServerUriException
  {
    return this.apiGet(API_PATH + "/entries", new BasicNameValuePair("oid", oid));
  }

  public RegistryResponse getVersions(String oid) throws HTTPException, BadServerUriException
  {
    return this.apiGet(API_PATH + "/versions", new BasicNameValuePair("oid", oid));
  }

  public RegistryResponse getVersion(String oid) throws HTTPException, BadServerUriException
  {
    return this.apiGet(API_PATH + "/version", new BasicNameValuePair("oid", oid), new BasicNameValuePair("includeTableDefinitions", "true"));
  }
