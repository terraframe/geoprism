...
public class GeoserverProperties 
{
  ...
  {
    return Singleton.getProps().getString("geoserver.remote.path", GeoprismProperties.getRemoteServerUrl() + "geoserver");
  }

  public static String getLocalPath()
  {
    return Singleton.getProps().getString("geoserver.local.path", "http://127.0.0.1:8080/geoserver");
  }
