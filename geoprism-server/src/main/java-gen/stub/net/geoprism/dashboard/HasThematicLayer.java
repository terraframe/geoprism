...
import net.geoprism.dashboard.HasThematicLayerBase;
...
public class HasThematicLayer extends HasThematicLayerBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public HasThematicLayer(net.geoprism.dashboard.DashboardMap parent, net.geoprism.dashboard.DashboardThematicLayer child)
  {
