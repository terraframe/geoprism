...
public enum AllLayerType implements com.runwaysdk.business.BusinessEnumeration, com.runwaysdk.generation.loader.Reloadable
{
  ...
  public static final java.lang.String CLASS = "net.geoprism.dashboard.AllLayerType";
  private net.geoprism.dashboard.LayerType enumeration;
  
  private synchronized void loadEnumeration()
  {
    net.geoprism.dashboard.LayerType enu = net.geoprism.dashboard.LayerType.getEnumeration(this.name());
    setEnumeration(enu);
  }
  
  private synchronized void setEnumeration(net.geoprism.dashboard.LayerType enumeration)
  {
