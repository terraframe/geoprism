...
public abstract class GeodashboardUserBase extends com.runwaysdk.system.Users implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.GeodashboardUser.CLASS);
  ...
  public static net.geoprism.GeodashboardUser[] getAllUsers()
  {
    String msg = "This method should never be invoked.  It should be overwritten in com.runwaysdk.geodashboard.GeodashboardUser.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static net.geoprism.GeodashboardUser getCurrentUser()
  {
    String msg = "This method should never be invoked.  It should be overwritten in com.runwaysdk.geodashboard.GeodashboardUser.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
