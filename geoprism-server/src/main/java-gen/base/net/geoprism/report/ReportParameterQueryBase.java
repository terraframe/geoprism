 ...
 implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.report.ReportParameter.ID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.report.ReportParameter.ID, alias, displayLabel);
