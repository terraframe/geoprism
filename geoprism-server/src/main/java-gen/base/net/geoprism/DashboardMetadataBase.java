...
public abstract class DashboardMetadataBase extends com.runwaysdk.business.Relationship implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.DashboardMetadata.CLASS);
  ...
  public net.geoprism.Dashboard getParent()
  {
    return (net.geoprism.Dashboard) super.getParent();
  }
  
  public net.geoprism.MetadataWrapper getChild()
  {
    return (net.geoprism.MetadataWrapper) super.getChild();
  }
