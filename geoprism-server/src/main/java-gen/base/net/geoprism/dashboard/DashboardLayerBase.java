...
public abstract class DashboardLayerBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.dashboard.DashboardLayer.CLASS);
  ...
  public java.util.List<net.geoprism.dashboard.AllLayerType> getLayerType()
  {
    return (java.util.List<net.geoprism.dashboard.AllLayerType>) getEnumValues(LAYERTYPE);
  }
  
  public void addLayerType(net.geoprism.dashboard.AllLayerType value)
  {
    if(value != null)
    {
  ...
  public void removeLayerType(net.geoprism.dashboard.AllLayerType value)
  {
    if(value != null)
    {
  ...
  public net.geoprism.dashboard.DashboardLayerNameLabel getNameLabel()
  {
    return (net.geoprism.dashboard.DashboardLayerNameLabel) nameLabel;
  }
  ...
  public net.geoprism.dashboard.HasLayer addContainingMap(net.geoprism.dashboard.DashboardMap dashboardMap)
  {
    return (net.geoprism.dashboard.HasLayer) addParent(dashboardMap, net.geoprism.dashboard.HasLayer.CLASS);
  }
  
  public void removeContainingMap(net.geoprism.dashboard.DashboardMap dashboardMap)
  {
    removeAllParents(dashboardMap, net.geoprism.dashboard.HasLayer.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMap> getAllContainingMap()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMap>) getParents(net.geoprism.dashboard.HasLayer.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.HasLayer> getAllContainingMapRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.HasLayer>) getParentRelationships(net.geoprism.dashboard.HasLayer.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.HasLayer> getContainingMapRel(net.geoprism.dashboard.DashboardMap dashboardMap)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.HasLayer>) getRelationshipsWithParent(dashboardMap, net.geoprism.dashboard.HasLayer.CLASS);
  }
