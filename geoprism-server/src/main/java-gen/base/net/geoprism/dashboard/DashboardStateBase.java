...
@com.runwaysdk.business.ClassSignature(hash = 383723456)
/**
 ...
 */
public abstract class DashboardStateBase extends com.runwaysdk.business.Business 
{
  ...
  private static final long serialVersionUID = 383723456;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.dashboard.DashboardState.CLASS);
  ...
  public static DashboardState get(String oid)
  {
    return (DashboardState) com.runwaysdk.business.Business.get(oid);
  }
  ...
  public static DashboardState lock(java.lang.String oid)
  {
    DashboardState _instance = DashboardState.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static DashboardState unlock(java.lang.String oid)
  {
    DashboardState _instance = DashboardState.get(oid);
    _instance.unlock();
