...
@com.runwaysdk.business.ClassSignature(hash = -531337606)
/**
 ...
 */
public abstract class DashboardBase extends com.runwaysdk.business.Business 
{
  ...
  private static final long serialVersionUID = -531337606;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.dashboard.Dashboard.CLASS);
  ...
  public net.geoprism.dashboard.DashboardDescription getDescription()
  {
    return (net.geoprism.dashboard.DashboardDescription) description;
  }
  ...
  public net.geoprism.dashboard.DashboardDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.dashboard.DashboardDisplayLabel) displayLabel;
  }
  ...
  public net.geoprism.dashboard.DashboardMetadata addMetadata(net.geoprism.dashboard.MetadataWrapper metadataWrapper)
  {
    return (net.geoprism.dashboard.DashboardMetadata) addChild(metadataWrapper, net.geoprism.dashboard.DashboardMetadata.CLASS);
  }
  
  public void removeMetadata(net.geoprism.dashboard.MetadataWrapper metadataWrapper)
  {
    removeAllChildren(metadataWrapper, net.geoprism.dashboard.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.MetadataWrapper> getAllMetadata()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.MetadataWrapper>) getChildren(net.geoprism.dashboard.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMetadata> getAllMetadataRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMetadata>) getChildRelationships(net.geoprism.dashboard.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMetadata> getMetadataRel(net.geoprism.dashboard.MetadataWrapper metadataWrapper)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.dashboard.DashboardMetadata>) getRelationshipsWithChild(metadataWrapper, net.geoprism.dashboard.DashboardMetadata.CLASS);
  }
  
  public static Dashboard get(String oid)
  {
    return (Dashboard) com.runwaysdk.business.Business.get(oid);
  }
  ...
  public static final java.lang.String applyWithOptions(java.lang.String oid, java.lang.String options)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public net.geoprism.dashboard.Dashboard clone(java.lang.String name)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.dashboard.Dashboard.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static final net.geoprism.dashboard.Dashboard clone(java.lang.String oid, java.lang.String name)
  {
    Dashboard _instance = Dashboard.get(oid);
    return _instance.clone(name);
  }
  
  public static net.geoprism.dashboard.Dashboard create(net.geoprism.dashboard.Dashboard dto)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.dashboard.Dashboard.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static final void generateThumbnailImage(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final net.geoprism.GeoprismUser[] getAllDashboardUsers(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getAllDashboardUsersJSON(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getConditionsJSON(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getDashboardDefinition(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getDashboardInformation(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final com.runwaysdk.query.ValueQuery getGeoEntitySuggestions(java.lang.String oid, java.lang.String text, java.lang.Integer limit)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final com.runwaysdk.system.gis.geo.GeoNode[] getGeoNodes(java.lang.String oid, com.runwaysdk.system.metadata.MdAttribute thematicAttribute)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getGeoNodesJSON(java.lang.String oid, com.runwaysdk.system.metadata.MdAttribute thematicAttribute)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getLayersToDelete(java.lang.String oid, java.lang.String options)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String getMapId(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
    return _instance.getMapId();
  }
  
  public static net.geoprism.dashboard.DashboardQuery getSortedDashboards()
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.dashboard.Dashboard.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static final com.runwaysdk.system.metadata.MdClass[] getSortedTypes(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.io.InputStream getThumbnailStream(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.Boolean hasAccess(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.Boolean hasReport(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final java.lang.String saveState(java.lang.String oid, java.lang.String state, java.lang.Boolean global)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final void setBaseLayerState(java.lang.String oid, java.lang.String baseLayerState)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final void setDashboardAttributesOrder(java.lang.String oid, java.lang.String typeId, java.lang.String[] attributeIds)
  {
    Dashboard _instance = Dashboard.get(oid);
  ...
  public static final void setMetadataWrapperOrder(java.lang.String oid, java.lang.String[] typeIds)
  {
    Dashboard _instance = Dashboard.get(oid);
    _instance.setMetadataWrapperOrder(typeIds);
  }
  
  public static Dashboard lock(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
    _instance.lock();
  ...
  public static Dashboard unlock(java.lang.String oid)
  {
    Dashboard _instance = Dashboard.get(oid);
    _instance.unlock();
