 ...
 
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.layer.DashboardLayerView.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.layer.DashboardLayerView.OID, alias, displayLabel);
