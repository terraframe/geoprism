...
public  class SessionMapQuery extends com.runwaysdk.query.GeneratedRelationshipQuery 
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.dashboard.SessionMap.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.dashboard.SessionMap.OID, alias, displayLabel);
