...
@com.runwaysdk.business.ClassSignature(hash = -1170025036)
/**
 ...
 */
public abstract class DashboardReferenceLayerViewBase extends com.runwaysdk.business.View 
{
  ...
  private static final long serialVersionUID = -1170025036;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.dashboard.layer.DashboardReferenceLayerView.CLASS);
  ...
  public static DashboardReferenceLayerView get(String oid)
  {
    return (DashboardReferenceLayerView) com.runwaysdk.business.View.get(oid);
  }
