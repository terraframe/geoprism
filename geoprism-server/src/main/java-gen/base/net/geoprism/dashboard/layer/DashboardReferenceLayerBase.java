 ...
 */
public abstract class DashboardReferenceLayerBase extends net.geoprism.dashboard.layer.DashboardLayer 
{
  ...
  public static DashboardReferenceLayer get(String oid)
  {
    return (DashboardReferenceLayer) com.runwaysdk.business.Business.get(oid);
  }
  ...
  public static DashboardReferenceLayer lock(java.lang.String oid)
  {
    DashboardReferenceLayer _instance = DashboardReferenceLayer.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static DashboardReferenceLayer unlock(java.lang.String oid)
  {
    DashboardReferenceLayer _instance = DashboardReferenceLayer.get(oid);
    _instance.unlock();
