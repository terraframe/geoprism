 ...
 
{
  ...
  {
    return net.geoprism.dashboard.layer.LayerType.CLASS;
  }
  /**  
 ...
 **/
  ...
  public com.runwaysdk.query.Condition enum_AllLayerType()
  {
    ...
    com.runwaysdk.dataaccess.MdEnumerationDAOIF mdEnumerationIF = com.runwaysdk.dataaccess.metadata.MdEnumerationDAO.getMdEnumerationDAO(net.geoprism.dashboard.layer.AllLayerType.CLASS); 
 ...
 **/
  public interface LayerTypeQueryReferenceIF extends  com.runwaysdk.system.EnumerationMasterQuery.EnumerationMasterQueryReferenceIF
  {
 ...
 implements LayerTypeQueryReferenceIF
  ...
  public LayerTypeQueryReference(com.runwaysdk.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.runwaysdk.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
    ...
    public com.runwaysdk.query.BasicCondition EQ(net.geoprism.dashboard.layer.LayerType layerType)
    {
      ...
      return this.EQ(layerType.getOid());
    }

    public com.runwaysdk.query.BasicCondition NE(net.geoprism.dashboard.layer.LayerType layerType)
    {
      if(layerType == null) return this.NE((java.lang.String)null);
      return this.NE(layerType.getOid());
    }
 ...
 **/
  public interface LayerTypeQueryEnumerationIF extends  com.runwaysdk.system.EnumerationMasterQuery.EnumerationMasterQueryEnumerationIF
  {
 ...
 **/
 ...
 implements LayerTypeQueryEnumerationIF
  {
...
/**
 * Specifies type safe query methods for the enumeration net.geoprism.dashboard.layer.AllLayerType.
 * This type is used when a join is performed on this class as an enumeration.
 **/
  public interface AllLayerTypeQueryIF extends  LayerTypeQueryEnumerationIF  {

    public com.runwaysdk.query.Condition containsAny(net.geoprism.dashboard.layer.AllLayerType ... allLayerType);
    public com.runwaysdk.query.Condition notContainsAny(net.geoprism.dashboard.layer.AllLayerType ... allLayerType);
    public com.runwaysdk.query.Condition containsAll(net.geoprism.dashboard.layer.AllLayerType ... allLayerType);
    public com.runwaysdk.query.Condition notContainsAll(net.geoprism.dashboard.layer.AllLayerType ... allLayerType);
    public com.runwaysdk.query.Condition containsExactly(net.geoprism.dashboard.layer.AllLayerType ... allLayerType);
  }

/**
 * Implements type safe query methods for the enumeration net.geoprism.dashboard.layer.AllLayerType.
 * This type is used when a join is performed on this class as an enumeration.
 **/
  public static class AllLayerTypeQuery extends LayerTypeQueryEnumeration implements  AllLayerTypeQueryIF
  {
  public AllLayerTypeQuery(com.runwaysdk.dataaccess.MdAttributeEnumerationDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, String mdEnumerationTableName,com.runwaysdk.dataaccess.MdBusinessDAOIF masterMdBusinessIF, String masterTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
    ...
    public com.runwaysdk.query.Condition containsAny(net.geoprism.dashboard.layer.AllLayerType ... allLayerType)  {
      ...
      {
        enumIdArray[i] = allLayerType[i].getOid();
      }
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public interface LayerTypeQueryMultiReferenceIF extends  com.runwaysdk.system.EnumerationMasterQuery.EnumerationMasterQueryMultiReferenceIF
  {


    public com.runwaysdk.query.Condition containsAny(net.geoprism.dashboard.layer.LayerType ... layerType);
    public com.runwaysdk.query.Condition notContainsAny(net.geoprism.dashboard.layer.LayerType ... layerType);
    public com.runwaysdk.query.Condition containsAll(net.geoprism.dashboard.layer.LayerType ... layerType);
    public com.runwaysdk.query.Condition notContainsAll(net.geoprism.dashboard.layer.LayerType ... layerType);
    public com.runwaysdk.query.Condition containsExactly(net.geoprism.dashboard.layer.LayerType ... layerType);
  }
 ...
 implements LayerTypeQueryMultiReferenceIF
  ...
  public LayerTypeQueryMultiReference(com.runwaysdk.dataaccess.MdAttributeMultiReferenceDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, String mdMultiReferenceTableName, com.runwaysdk.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
    ...
    public com.runwaysdk.query.Condition containsAny(net.geoprism.dashboard.layer.LayerType ... layerType)  {
      ...
      {
        itemIdArray[i] = layerType[i].getOid();
      }
