...
import net.geoprism.dashboard.DashboardLayerView;

@com.runwaysdk.business.ClassSignature(hash = 2143678714)
/**
 ...
 implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    return net.geoprism.dashboard.DashboardLayerView.CLASS;
  }
  ...
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ACTIVEBYDEFAULT, alias, null);

  }
 
  public com.runwaysdk.query.SelectableBoolean getActiveByDefault(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ACTIVEBYDEFAULT, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.AGGREGATIONATTRIBUTE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getAggregationAttribute(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.AGGREGATIONATTRIBUTE, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.AGGREGATIONMETHOD, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getAggregationMethod(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.AGGREGATIONMETHOD, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ATTRIBUTELABEL, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getAttributeLabel(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ATTRIBUTELABEL, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.DISPLAYINLEGEND, alias, null);

  }
 
  public com.runwaysdk.query.SelectableBoolean getDisplayInLegend(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.DISPLAYINLEGEND, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.FEATURESTRATEGY, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getFeatureStrategy(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.FEATURESTRATEGY, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.GROUPEDINLEGEND, alias, null);

  }
 
  public com.runwaysdk.query.SelectableBoolean getGroupedInLegend(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.GROUPEDINLEGEND, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.ID, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getLayerId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERID, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERISACTIVE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableBoolean getLayerIsActive(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableBoolean)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERISACTIVE, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERNAME, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getLayerName(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LAYERNAME, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LEGENDXPOSITION, alias, null);

  }
 
  public com.runwaysdk.query.SelectableInteger getLegendXPosition(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LEGENDXPOSITION, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LEGENDYPOSITION, alias, null);

  }
 
  public com.runwaysdk.query.SelectableInteger getLegendYPosition(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.LEGENDYPOSITION, alias, displayLabel);
  ...
  public com.runwaysdk.system.metadata.MdAttributeQuery.MdAttributeQueryReferenceIF getMdAttribute(String alias)
  {
    ...
    return (com.runwaysdk.system.metadata.MdAttributeQuery.MdAttributeQueryReferenceIF)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.MDATTRIBUTE, alias, null);
  ...
  public com.runwaysdk.system.metadata.MdAttributeQuery.MdAttributeQueryReferenceIF getMdAttribute(String alias, String displayLabel)
  {
    ...
    return (com.runwaysdk.system.metadata.MdAttributeQuery.MdAttributeQueryReferenceIF)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.MDATTRIBUTE, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.SLDNAME, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getSldName(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.SLDNAME, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.VIEWNAME, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getViewName(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(net.geoprism.dashboard.DashboardLayerView.VIEWNAME, alias, displayLabel);
