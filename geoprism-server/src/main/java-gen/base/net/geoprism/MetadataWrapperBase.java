...
public abstract class MetadataWrapperBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.MetadataWrapper.CLASS);
  ...
  public net.geoprism.DashboardAttributes addAttributeWrapper(net.geoprism.AttributeWrapper attributeWrapper)
  {
    return (net.geoprism.DashboardAttributes) addChild(attributeWrapper, net.geoprism.DashboardAttributes.CLASS);
  }
  
  public void removeAttributeWrapper(net.geoprism.AttributeWrapper attributeWrapper)
  {
    removeAllChildren(attributeWrapper, net.geoprism.DashboardAttributes.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.AttributeWrapper> getAllAttributeWrapper()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.AttributeWrapper>) getChildren(net.geoprism.DashboardAttributes.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardAttributes> getAllAttributeWrapperRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardAttributes>) getChildRelationships(net.geoprism.DashboardAttributes.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardAttributes> getAttributeWrapperRel(net.geoprism.AttributeWrapper attributeWrapper)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardAttributes>) getRelationshipsWithChild(attributeWrapper, net.geoprism.DashboardAttributes.CLASS);
  }
  
  public net.geoprism.DashboardMetadata addDashboard(net.geoprism.Dashboard dashboard)
  {
    return (net.geoprism.DashboardMetadata) addParent(dashboard, net.geoprism.DashboardMetadata.CLASS);
  }
  
  public void removeDashboard(net.geoprism.Dashboard dashboard)
  {
    removeAllParents(dashboard, net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.Dashboard> getAllDashboard()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.Dashboard>) getParents(net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata> getAllDashboardRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata>) getParentRelationships(net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata> getDashboardRel(net.geoprism.Dashboard dashboard)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata>) getRelationshipsWithParent(dashboard, net.geoprism.DashboardMetadata.CLASS);
  }
  ...
  public static final net.geoprism.MdAttributeView[] getSortedAttributes(java.lang.String id)
  {
