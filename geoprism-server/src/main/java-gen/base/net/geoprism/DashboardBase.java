...
public abstract class DashboardBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.Dashboard.CLASS);
  ...
  public net.geoprism.DashboardDescription getDescription()
  {
    return (net.geoprism.DashboardDescription) description;
  }
  ...
  public net.geoprism.DashboardDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.DashboardDisplayLabel) displayLabel;
  }
  ...
  public net.geoprism.DashboardMetadata addMetadata(net.geoprism.MetadataWrapper metadataWrapper)
  {
    return (net.geoprism.DashboardMetadata) addChild(metadataWrapper, net.geoprism.DashboardMetadata.CLASS);
  }
  
  public void removeMetadata(net.geoprism.MetadataWrapper metadataWrapper)
  {
    removeAllChildren(metadataWrapper, net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.MetadataWrapper> getAllMetadata()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.MetadataWrapper>) getChildren(net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata> getAllMetadataRel()
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata>) getChildRelationships(net.geoprism.DashboardMetadata.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata> getMetadataRel(net.geoprism.MetadataWrapper metadataWrapper)
  {
    return (com.runwaysdk.query.OIterator<? extends net.geoprism.DashboardMetadata>) getRelationshipsWithChild(metadataWrapper, net.geoprism.DashboardMetadata.CLASS);
  }
  ...
  public static final net.geoprism.Dashboard clone(java.lang.String id, java.lang.String name)
  {
    Dashboard _instance = Dashboard.get(id);
