...
public  class ClassifierSynonymMultiTermAttributeRootQuery extends com.runwaysdk.query.GeneratedRelationshipQuery 
{
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.ontology.ClassifierSynonymMultiTermAttributeRoot.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.ontology.ClassifierSynonymMultiTermAttributeRoot.OID, alias, displayLabel);
