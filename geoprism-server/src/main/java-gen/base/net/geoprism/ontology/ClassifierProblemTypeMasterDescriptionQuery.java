...
@com.runwaysdk.business.ClassSignature(hash = -647561656)
/**
 ...
 */
public  class ClassifierProblemTypeMasterDescriptionQuery extends com.runwaysdk.query.GeneratedStructQuery 
{

  public ClassifierProblemTypeMasterDescriptionQuery(com.runwaysdk.query.QueryFactory componentQueryFactory)
  {
     super();
  ...
  public ClassifierProblemTypeMasterDescriptionQuery(com.runwaysdk.query.ValueQuery valueQuery)
  {
     super();
    if (this.getComponentQuery() == null)
    {
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.ontology.ClassifierProblemTypeMasterDescription.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getComponentQuery().get(net.geoprism.ontology.ClassifierProblemTypeMasterDescription.OID, alias, displayLabel);
   ...
   * on this query object.
   */
  public com.runwaysdk.query.OIterator<? extends ClassifierProblemTypeMasterDescription> getIterator()
  {
    ...
    return new com.runwaysdk.business.StructIterator<ClassifierProblemTypeMasterDescription>(this.getComponentQuery().getMdEntityIF(), columnInfoMap, results);
  }
 ...
 **/
  public interface ClassifierProblemTypeMasterDescriptionQueryStructIF extends com.runwaysdk.query.AttributeLocalIF
  {
 ...
 * This type is used when a join is performed on this class as a struct attribute.
 **/
  public static class ClassifierProblemTypeMasterDescriptionQueryStruct extends com.runwaysdk.query.AttributeLocal implements ClassifierProblemTypeMasterDescriptionQueryStructIF
  {

  public ClassifierProblemTypeMasterDescriptionQueryStruct(com.runwaysdk.dataaccess.MdAttributeLocalDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.runwaysdk.dataaccess.MdLocalStructDAOIF mdStructIF, String structTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
  ...
  public com.runwaysdk.query.SelectableChar getOid(String alias)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.ontology.ClassifierProblemTypeMasterDescription.OID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getOid(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.get(net.geoprism.ontology.ClassifierProblemTypeMasterDescription.OID, alias, displayLabel);
