...
public abstract class GeoEntityUtilBase extends com.runwaysdk.business.Util 
{
  ...
  private static final long serialVersionUID = 1722546625;
  ...
  public static void deleteGeoEntity(java.lang.String oid)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static com.runwaysdk.query.ValueQuery getChildren(java.lang.String oid, java.lang.String universalId, java.lang.Integer limit)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static java.lang.String getChildrenBBOX(java.lang.String oid, java.lang.String universalId)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static com.runwaysdk.system.gis.geo.GeoEntity getEntity(java.lang.String oid)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static com.runwaysdk.query.ValueQuery getGeoEntitySuggestions(java.lang.String parentOid, java.lang.String universalId, java.lang.String text, java.lang.Integer limit)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static com.runwaysdk.system.gis.geo.GeoEntity[] getOrderedAncestors(java.lang.String oid)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  ...
  public static java.lang.String publishLayers(java.lang.String oid, java.lang.String universalId, java.lang.String existingLayerNames)
  {
    String msg = "This method should never be invoked.  It should be overwritten in net.geoprism.ontology.GeoEntityUtil.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
