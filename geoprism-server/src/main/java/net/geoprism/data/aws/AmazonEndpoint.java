...
public class AmazonEndpoint implements XMLEndpoint
{
  ...
  public void copyFiles(File directory, List<String> keys, boolean preserveDirectories)
  {
    try
    {
      ...
      AmazonS3 client = new AmazonS3Client(new ClasspathPropertiesFileCredentialsProvider("AwsCredentialsForOpenData.properties"));
  ...
  private List<String> listFiles(String prefix)
  {
    ...
    try
    {
      AmazonS3 s3Client = new AmazonS3Client(new ClasspathPropertiesFileCredentialsProvider("AwsCredentialsForOpenData.properties"));
