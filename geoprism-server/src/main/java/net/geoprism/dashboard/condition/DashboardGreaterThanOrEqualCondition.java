...
public class DashboardGreaterThanOrEqualCondition extends DashboardPrimitiveCondition 
{
  /**
  ...
  public DashboardGreaterThanOrEqualCondition(String mdAttributeId, String comparisonValue)
  {
